...
$PODMAN_CMD run --cap-add AUDIT_CONTROL \
    ...
    -v ${src_dir}/containers/server-image/root/docker-entrypoint-initdb.d/00-mgrSetup.sh:/docker-entrypoint-initdb.d/00-mgrSetup.sh \
    ...
    bash -xc "/testsuite/podman_runner/provide-db-schema.sh && \
             ...
             /docker-entrypoint-initdb.d/00-mgrSetup.sh && \
