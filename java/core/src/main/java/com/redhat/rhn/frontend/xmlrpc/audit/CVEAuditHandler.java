...
public class CVEAuditHandler extends BaseHandler {
     ...
     * identifier using VEX data. Please note that the query code relies on data
     * that is pre-generated by the python VEX processor module.
