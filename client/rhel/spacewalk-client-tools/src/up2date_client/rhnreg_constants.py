...
SATELLITE_URL_WINDOW  = _("Enter your Uyuni URL.")
SATELLITE_URL_TEXT    = _("Please enter the location of your Uyuni "
                          "server and of its SSL "
                          "certificate. The SSL certificate is only required "
                          "if you will be connecting over https (recommended).")
SATELLITE_URL_PROMPT  = _("Uyuni URL:")
SATELLITE_URL_PROMPT2 = _("SSL certificate:")
SATELLITE_REQUIRED    = _("You must enter a valid Uyuni URL.")
...
CONNECT_WINDOW_TEXT   = _("We are attempting to contact the Uyuni "
                          "server at %s.")
...
START_REGISTER_TEXT   = _("This assistant will guide you through "
                          ...
                          "Uyuni to receive software "
                          "updates, including "
                          "security updates, to keep your system supported "
                          "and compliant.  "
                          "You will need the following at this time:\n\n"
                          " * A network connection\n"
                          " * Your Uyuni Login & password\n"
                          " * The location of a Uyuni Server "
                          "or Proxy\n\n")

# Why Register Window
WHY_REGISTER          = _("Why Should I Connect to Uyuni? ...")
WHY_REGISTER_WINDOW   = _("Why Register")
WHY_REGISTER_TEXT     = _("Connecting your system to Uyuni allows you to take full "
...
CONFIRM_QUIT_SURE       = _("Are you sure you don't want to connect your system to Uyuni? "
...
CONFIRM_QUIT_WILLNOT       = _("You will not be able to take advantage of these subscription privileges without connecting "
                           "your system to Uyuni.\n")
CONTINUE_REGISTERING   = _("Take me back to the setup process.")
REGISTER_LATER2        = _("I'll register later.")

# Info Window
REGISTER_WINDOW   = _("Uyuni Account")
LOGIN_PROMPT      = _("Please enter your login information for the %s Uyuni:\n\n")
HOSTED_LOGIN      = _("Uyuni Login:")
LOGIN             = _("Login:")
PASSWORD          = _("Password:")
LOGIN_TIP         = _("Tip: Forgot your login or password?  Contact your "
                      "Uyuni Organization Administrator.")
...
HARDWARE_WINDOW_DESC1 = _("A Profile Name is a descriptive name that"
                          ...
                          " on the Uyuni web pages. Optionally,"
...
# Send Window
SEND_WINDOW      = _("Send Profile Information to Uyuni")
SEND_WINDOW_DESC = _("We are finished collecting information for the System Profile.\n\n"
                     "Press \"Next\" to send this System Profile to Uyuni.  "
...
# Sending Window
SENDING_WINDOW = _("Sending Profile to Uyuni")
...
FINISH_WINDOW_TEXT_TUI  = _("You may now run '%s update' from this system's "
                            ...
                            "software updates from Uyuni. You will need to run this "
                            "periodically to "
...
SUB_NUM                 = _("The installation number %s was activated during "
                            "this system's initial connection to Uyuni.")
...
CHANNELS_SAT_WARNING    = _("Warning: Only installed product listed above will receive "
                            ...
                            "login to your Uyuni web interface "
...
"Contact your Uyuni administrator about this problem. Once you make the "
...
VIRT_FAILED = _("<b>Warning:</b> Any guest systems you create on this system "
        "and register to Uyuni will consume system "
        ...
        "system in Uyuni web interface if you do not want virtual guests of "
...
"appropriate active subscriptions available in your account, you may browse "
"to this system's profile in the Uyuni web interface, delete the profile, and "
"re-connect this system to Uyuni.")
ACTIVATION_KEY          = _("Universal default activation key detected\n"
                            ...
                            "for your system's connection to Uyuni Server or Uyuni Proxy"
                            "have been determined by the activation key rather than your "
                            "installation number.  "
                            "You may also refer to the Uyuni Reference Guide for more details "
...
WARNING                    = _("Warning")
HOSTED_CONNECTION_ERROR    = _("We can't contact Uyuni.\n\n"
                               ...
                               "without connecting to an Uyuni server/proxy")
...
SSL_CERT_ERROR_MSG         = _("<b><span size=\"16000\">Incompatible Certificate File</span></b>\n\n"
                               ...
                               " the Uyuni server at <b>%s</b>. You may want to double-check"
...
SSL_CERT_FILE_NOT_FOUND_ERRER = _("Please verify the values of sslCACert and serverURL in "
                                  ...
                                  "download the SSL cert from your Uyuni, place it "
...
ACT_KEY_USAGE_LIMIT_ERROR = _("Problem registering system.\n\n"
                              ...
                              "the Uyuni organization associated with your "
                              "login. To allow this system to connect, "
                              "please contact your Uyuni organization "
