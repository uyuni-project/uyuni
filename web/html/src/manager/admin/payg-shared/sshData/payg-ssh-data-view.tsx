...
const PaygShhDataView = (props: Props) => {
  return (
    <div>
      <dl className="row">
        <dt className="col-xs-2">{t("Host")}</dt>
        <dd className="col-xs-10">{props.isInstance ? props.payg.host : props.payg.bastion_host}</dd>
      </dl>
      <dl className="row">
        <dt className="col-xs-2">{t("SSH Port")}</dt>
        <dd className="col-xs-10">{props.isInstance ? props.payg.port : props.payg.bastion_port}</dd>
      </dl>
      <dl className="row">
        <dt className="col-xs-2">{t("User")}</dt>
        <dd className="col-xs-10">{props.isInstance ? props.payg.username : props.payg.bastion_username}</dd>
      </dl>
      <dl className="row">
