...
public class InstalledPackageId implements Serializable {

    @Serial
    private static final long serialVersionUID = -7487150882093547112L;
     ...
     */
    public InstalledPackageId(Server serverIn, PackageEvr evrIn, PackageName nameIn, PackageArch archIn) {
        server = serverIn;
        evr = evrIn;
        name = nameIn;
        arch = archIn;
    ...
    public boolean equals(Object oIn) {
        if (!(oIn instanceof InstalledPackageId that)) {
            return false;
        }
