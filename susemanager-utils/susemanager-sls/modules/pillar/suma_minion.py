...
MANAGER_PILLAR_DATA_PATHS = [
    "/srv/susemanager/pillar_data",
    "/var/lib/susemanager/pillar_data",
]
...
FORMULAS_DATA_PATHS = [
    ...
    "/var/lib/susemanager/formula_data",
]
...
def load_static_pillars(pillar):
    ...
    for static_pillar in MANAGER_STATIC_PILLAR:
        static_pillar_filename = os.path.join(
            MANAGER_STATIC_PILLAR_DATA_PATH, static_pillar
        )
        try:
            pillar.update(
                yaml.load(
