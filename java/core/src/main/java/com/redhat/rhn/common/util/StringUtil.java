...
public class StringUtil {
    ...
    /**
     * Returns a String for HTML parsing, escaping HTML, converting {@code \n} to a break tag ({@code <br>}), and
     * converting URLs beginning with {@code http://} and {@code https://} to link tags ({@code <a>}).
     * <p>
