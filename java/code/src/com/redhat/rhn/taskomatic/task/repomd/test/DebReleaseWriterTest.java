...
public class DebReleaseWriterTest extends BaseTestCaseWithUser {
    ...
    public void testGenerateRelease() throws Exception {
        ...
        String rel = "Archive: " + channel.getLabel() + "\n" +
                ...
                " d41d8cd98f00b204e9800998ecf8427e 0 repodata/binary-ia64/Packages\n" +
                " 3970e82605c7d109bb348fc94e9eecc0 20 repodata/binary-ia64/Packages.gz\n" +
                "SHA1:\n" +
                ...
                " da39a3ee5e6b4b0d3255bfef95601890afd80709 0 repodata/binary-ia64/Packages\n" +
