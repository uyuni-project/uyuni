...
Feature: Bootstrap an Oracle 10 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on an Oracle 10 Salt SSH minion
    When I perform a full salt minion cleanup on "oracle10_ssh_minion"
  ...
  Scenario: Bootstrap an Oracle 10 Salt SSH minion
    ...
    And I enter the hostname of "oracle10_ssh_minion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-oracle10_ssh_minion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "oracle10_ssh_minion"

@proxy
  Scenario: Check connection from Oracle 10 Salt SSH minion to proxy
    Given I am on the Systems overview page of this "oracle10_ssh_minion"
...
@proxy
  Scenario: Check registration on proxy of Oracle 10 Salt SSH minion
    ...
    Then I should see "oracle10_ssh_minion" hostname

@monitoring_server
  Scenario: Prepare Oracle 10 Salt SSH minion firewall for monitoring
    When I enable firewall ports for monitoring on this "oracle10_ssh_minion"
