...
@scc_credentials
  Scenario: Add a product with recommended enabled
    ...
    And I open the sub-list of the product "Desktop Applications Module 15 SP3 x86_64"
    ...
    And I should see the "Development Tools Module 15 SP3 x86_64" selected
    When I select "Containers Module 15 SP3 x86_64" as a product
