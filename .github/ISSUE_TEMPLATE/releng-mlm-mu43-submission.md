---
name: SUSE Multi-Linux Manager 4.3 MU submission
about: Use this template for SUSE Multi-Linux Manager 4.3 MU submissions
...
- [ ] Send an email to galaxy-devel@suse.de informing that the branch `Manager-4.3` is locked, and adjust the topic on the slack [#team-multi-linux-manager](https://app.slack.com/client/T02863RC2AC/C02D78LLS04) channel
...
- [ ] Check if schema migration directories exist between older and newer SUSE Multi-Linux Manager version (more at https://confluence.suse.com/display/SUSEMANAGER/Maintenance+Update+procedure)
...
- [ ] Add the IDs (and notes, if any), to the JIRA ticket, and ping the Maintenance Team at [#discuss-multi-linux-manager-maintenance](https://app.slack.com/client/T02863RC2AC/C02DEF2U0E5)
...
- [ ] Send an email to galaxy-devel@suse.de informing that the branch `Manager-4.3` is unlocked , and adjust the topic on the slack [#team-multi-linux-manager](https://app.slack.com/client/T02863RC2AC/C02D78LLS04) channel
