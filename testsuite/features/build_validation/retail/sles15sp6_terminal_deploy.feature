...
Feature: PXE boot a SLES 15 SP6 retail terminal
  ...
  Scenario: PXE boot the SLES 15 SP6 retail terminal
    When I reboot the Retail terminal "sles15sp6_terminal" through the interface "eth1"
    And I wait at most 180 seconds until Salt master sees "sles15sp6_terminal" as "unaccepted"
    And I accept "sles15sp6_terminal" key in the Salt master
    And I follow the left menu "Systems > System List > All"
    And I wait until I see the name of "sles15sp6_terminal", refreshing the page
    And I follow this "sles15sp6_terminal" link
    And I follow "Events"
    ...
    Then "sles15sp6_terminal" should have been reformatted

  Scenario: Check connection from SLES 15 SP6 retail terminal to branch server
    Given I am authorized for the "Admin" section
    When I navigate to the Systems overview page of this "sles15sp6_terminal"
