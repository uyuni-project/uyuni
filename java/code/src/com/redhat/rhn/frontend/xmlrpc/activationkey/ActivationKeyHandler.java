...
public class ActivationKeyHandler extends BaseHandler {
     ...
     * @xmlrpc.param #param_desc("string", "key", "Leave empty to have new key autogenerated.")
     * @xmlrpc.param #param("string", "description")
     * @xmlrpc.param #param_desc("string", "baseChannelLabel", "Leave empty to accept default.")
     ...
     * @xmlrpc.param #array_single_desc("string", "entitlements",
     ...
     * @xmlrpc.param #param("string", "description")
     * @xmlrpc.param #param_desc("string", "baseChannelLabel", "Leave empty to accept default.")
     * @xmlrpc.param #array_single_desc("string", "entitlements", "Add-on entitlement label to associate with the key.")
     *   #options()
     *     #item("virtualization_host")
     *   #options_end()
     * @xmlrpc.param #param("boolean", "universalDefault")
     ...
     * @xmlrpc.param #session_key()
     * @xmlrpc.param #param("string", "key")
     * @xmlrpc.param #struct_begin("details")
     ...
     * @xmlrpc.param #session_key()
     * @xmlrpc.param #param("string", "key")
     * @xmlrpc.param #array_single("string", "childChannelLabels")
     * @xmlrpc.returntype #return_int_success()
     */
     ...
     * @xmlrpc.param #session_key()
     * @xmlrpc.param #param("string", "key")
     * @xmlrpc.param #array_single("int", "serverGroupIds")
     * @xmlrpc.returntype #return_int_success()
     */
