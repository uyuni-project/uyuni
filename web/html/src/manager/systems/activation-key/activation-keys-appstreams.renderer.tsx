...
export const renderer = (parent: Element, { channelsAppStreams }: RendererProps) => {
  ...
  SpaRenderer.renderNavigationReact(<AppStreams channelsAppStreams={channelsAppStreamsJson} />, parent);
};
