...
-- Need to update to match the web_user_personal_info fields
...
begin
    ...
    if address1_in IS NOT NULL AND trim(address1_in) != '' then
        ...
        values
            ...
            address1_in, address2_in,
            city_in, state_in, zip_in, country_in, phone_in, fax_in);
    end if;
