...
Then(/^the SLE15 SP1 products should be added$/) do
  output, _code = $server.run('echo -e "admin\nadmin\n" | mgr-sync list channels', check_errors: false, buffer_size: 1_000_000)
  raise unless output.include? '[I] SLE-Product-SLES15-SP1-Pool for x86_64 SUSE Linux Enterprise Server 15 SP1 x86_64 [sle-product-sles15-sp1-pool-x86_64]'
  raise unless output.include? '[I] SLE-Module-Basesystem15-SP1-Updates for x86_64 Basesystem Module 15 SP1 x86_64 [sle-module-basesystem15-sp1-updates-x86_64]'
end
