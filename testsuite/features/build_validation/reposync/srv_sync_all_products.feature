...
@fast
  Scenario: Partially add SUSE Linux Enterprise Server 12 SP5
    When I use spacewalk-repo-sync to sync all channels for "sles12-sp5" including only client tools dependencies
    And I use spacewalk-repo-sync to sync channel "managertools-sle12-pool-x86_64-sp5"
    And I use spacewalk-repo-sync to sync channel "managertools-sle12-updates-x86_64-sp5"
