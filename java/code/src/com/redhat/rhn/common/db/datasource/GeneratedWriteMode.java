 ...
 */
public class GeneratedWriteMode extends WriteMode {
     ...
     */
    public GeneratedWriteMode(String name, Session session, String sqlStatement, Collection<String> parameters) {
