...
public class XmlRpcTestUtils {
    ...
    public static HandlerFactory getTestHandlerFactory() {
        ...
        factory.addHandler("registration", new com.redhat.rhn.frontend.xmlrpc.RegistrationHandler());
        factory.addHandler("unittest", new com.redhat.rhn.frontend.xmlrpc.UnitTestHandler());
        return factory;
    }
}
