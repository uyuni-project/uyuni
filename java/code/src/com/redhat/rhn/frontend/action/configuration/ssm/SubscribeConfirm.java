...
public class SubscribeConfirm extends RhnAction {
    ...
    private static final Logger LOG = Logger.getLogger(SubscribeConfirm.class);
    ...
    private ActionForward confirm(ActionMapping mapping,
        ...
        LOG.debug(String.format("End adding config state, duration: %s", Duration.between(start, LocalDateTime.now())));
