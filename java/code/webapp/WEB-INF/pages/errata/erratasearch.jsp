        ...
        <%@ taglib uri="http://struts.apache.org/tags-bean" prefix="bean" %>
          <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
            ...
            <body>
              ...
              <p>
                <bean:message key="erratasearch.jsp.summary" />
              </p>
              ...
              <html:form styleClass="form-horizontal" action="/errata/Search.do">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4>
                      <bean:message key="erratasearch.jsp.instructions" />
                    </h4>
                  </div>
                    ...
                    <table class="table">
                      <tr>
                        ...
                        <td>
                          <div class="row-0">
                            <div class="col-md-5">
                              <html:text property="search_string" styleClass="form-control input-sm"
                                name="search_string" value="${search_string}" maxlength="36" accesskey="4" />
                            </div>
                            <span class="col-md-7">
                              <strong>
                                <bean:message key="Examples" />:
                              </strong>
                              <bean:message key="erratasearch.jsp.search.tip" />
                            </span>
                          </div>
                        </td>
                      </tr>
                          ...
                          <div class="row-0">
                            <div class="col-md-5">
                              <html:select property="view_mode" styleClass="form-control input-sm">
                                <html:options collection="searchOptions" property="value" labelProperty="display" />
                              </html:select>
                            </div>
                            <span class="col-md-7">
                              <strong>
                              ...
                              <bean:message key="erratasearch.jsp.whatsearch.tip" />
                            </span>
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="checkbox">
                            <html:checkbox styleId="issueDateOptionsCheckBox" property="optionIssueDateSearch"
                              onclick="javascript:issueDateSearchOptions()">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="checkbox">
                            <html:checkbox property="fineGrained" styleId="fineGrainedlabel"> <label
                                for="fineGrainedlabel">
              ...
              <c:if test="${(search_string != null && search_string != '') || param.optionIssueDateSearch != null }">
                ...
                <rl:listset name="searchSet" legend="errata">
                  <rhn:csrf />
                  <rl:list name="searchResults" dataset="pageList" emptykey="erratasearch.jsp.noerrata" width="100%">
                      ...
                      <c:if test="${current.securityAdvisory}">
                        <c:choose>
                          <c:when test="${current.severityid=='0'}">
                            <rhn:icon type="errata-security-critical" title="erratalist.jsp.securityadvisory" />
                          </c:when>
                          <c:when test="${current.severityid=='1'}">
                            <rhn:icon type="errata-security-important" title="erratalist.jsp.securityadvisory" />
                          </c:when>
                          <c:when test="${current.severityid=='2'}">
                            <rhn:icon type="errata-security-moderate" title="erratalist.jsp.securityadvisory" />
                          </c:when>
                          <c:when test="${current.severityid=='3'}">
                            <rhn:icon type="errata-security-low" title="erratalist.jsp.securityadvisory" />
                          </c:when>
                          <c:otherwise>
                    ...
                    <rl:column bound="false" sortable="true" sortattr="advisoryName"
                    ...
                    <c:choose>
                      ...
                      <c:when test="${view_mode == 'errata_search_by_advisory'}">
                        <%-- If this is a errata_search_by_advisory, we display the synopsis column, but call it Errata
                          Advisory --%>
                          <rl:column bound="false" sortable="true" sortattr="advisorySynopsis"
                      ...
                      <c:when test="${view_mode == 'errata_search_by_package_name'}">
                        <%-- If this is a errata_search_by_package_name, we display a Package Name column. --%>
                      ...
                      <c:when test="${view_mode == 'errata_search_by_issue_date'}">
                        <%-- If this is a errata_search_by_issue_date, we display the advisory synopsis and the issue
                          date --%>
                      ...
                      <c:when test="${view_mode == 'errata_search_by_cve'}">
                        <%-- If this is a errata_search_by_cve, we display all the cves per errata --%>
                          <rl:column bound="false" sortable="false" headerkey="erratalist.jsp.synopsis">
                            ${current.advisorySynopsis}
                          </rl:column>
