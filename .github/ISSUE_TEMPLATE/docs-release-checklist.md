---
name: Documentation Release Checklist - MLM
about: Use this issue template for documentation releases.
title: "Documentation Release Checklist - MLM X.YY"
labels: ["docs-squad"]
projects: ["SUSE/39"]
...
# Documentation Release Checklist - MLM

Use this issue template for MLM documentation releases.
...
- [ ] For MLM, cut a new branch from the release branch using syntax `manager-x.y-MU-x.y.z` for MUs, or `manager-x.y-milestone` for alpha, beta, or RC releases.
