...
version was bumped yet. It does that on every run, so scripts in here must
be safe to apply more than once. They keep being re-applied on every server
start until a release moves them out.
