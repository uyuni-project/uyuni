...
Feature: Bootstrap a SLE Micro 5.2 Salt minion
  ...
  Scenario: Bootstrap a SLE Micro 5.2 minion
    When I follow the left menu "Systems > Bootstrapping"
    Then I should see a "Bootstrap Minions" text
    When I enter the hostname of "slemicro52_minion" as "hostname"
    And I enter "22" as "port"
    And I enter "root" as "user"
    And I enter "linux" as "password"
    And I select "1-slemicro52_minion_key" from "activationKeys"
  ...
  Scenario: Reboot the SLE Micro 5.2 minion and wait until reboot is completed
    Given I am on the Systems overview page of this "slemicro52_minion"
...
@proxy
  Scenario: Check registration on proxy of SLE Micro 5.2 minion
    Given I am on the Systems overview page of this "proxy"
    When I follow "Details" in the content area
    And I follow "Proxy" in the content area
    Then I should see "slemicro52_minion" hostname

  Scenario: Check events history for failures on SLE Micro 5.2 minion
    Given I am on the Systems overview page of this "slemicro52_minion"
