        ...
        return (
          <VirtualizationListRefreshApi serverId={props.serverId} lastRefresh={lastRefresh} type="pools">
            {({ data: pools, error: refreshError }) => {
              ...
              function renderVolume(volume: any, renderNameColumn: Function) {
                return [
              ...
              function renderItem(item: TreeItem, renderNameColumn: Function) {
                const itemRenderers = {
                  pool: renderPool,
                  volume: renderVolume,
                };
              ...
              return (
                <>
                  ...
                  <Messages items={([] as any[]).concat(messages, refreshError || [], getCreationActionMessages())} />
                  <CustomDataHandler
