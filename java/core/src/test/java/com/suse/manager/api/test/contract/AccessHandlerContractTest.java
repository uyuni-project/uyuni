...
public class AccessHandlerContractTest extends BaseOpenApiTest {
    ...
    @Override
    protected Class<AccessHandler> getHandlerClass() {
        return AccessHandler.class;
    }
    ...
    private AccessGroup createFakeAccessGroup(String label, String desc) {
        ...
        accessGroup.setLabel(label);
        accessGroup.setDescription(desc);
        accessGroup.setOrg(fakeOrg);
        return accessGroup;
    }
}
