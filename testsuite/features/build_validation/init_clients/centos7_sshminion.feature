...
Feature: Bootstrap a CentOS 7 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on a CentOS 7 Salt SSH minion
    When I perform a full salt minion cleanup on "centos7_sshminion"
  ...
  Scenario: Bootstrap a CentOS 7 Salt SSH minion
    ...
    And I enter the hostname of "centos7_sshminion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-centos7_sshminion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "centos7_sshminion"

@proxy
  Scenario: Check connection from CentOS 7 Salt SSH minion to proxy
    Given I am on the Systems overview page of this "centos7_sshminion"
...
@proxy
  Scenario: Check registration on proxy of CentOS 7 Salt SSH minion
    ...
    Then I should see "centos7_sshminion" hostname
