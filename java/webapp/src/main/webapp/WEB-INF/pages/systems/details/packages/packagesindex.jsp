...
<ul>
  <li>
    <rhn:require acl="not system_feature(ftr_package_remove)">
      <a href="/rhn/systems/details/packages/PackageList.do?sid=${param.sid}" class="js-spa">
  ...
  <rhn:require acl="system_feature(ftr_package_verify); client_capable(packges.verify) or client_capable(packages.verify)"
      ...
      <li><a href="/rhn/systems/details/packages/VerifyPackages.do?sid=${param.sid}" class="js-spa">
        <bean:message key="packagesindex.jsp.verify"/></a></li>
  </rhn:require>

  <rhn:require acl="system_feature(ftr_package_updates)">
      <li><a href="/rhn/systems/details/packages/UpgradableList.do?sid=${param.sid}" class="js-spa">
        <bean:message key="packagesindex.jsp.upgrade"/></a></li>
      <li><a href="/rhn/systems/details/packages/InstallPackages.do?sid=${param.sid}" class="js-spa">
        <bean:message key="packagesindex.jsp.install"/></a></li>
  </rhn:require>

  <rhn:require acl="system_feature(ftr_profile_compare)">
      <li><a href="/rhn/systems/details/packages/profiles/ShowProfiles.do?sid=${param.sid}" class="js-spa">
        <bean:message key="packagesindex.jsp.profiles"/></a></li>
  </rhn:require>

  <rhn:require acl="system_has_salt_entitlement()">
      <li><a href="/rhn/manager/systems/details/packages?sid=${param.sid}" class="js-spa">
