...
# QualityIntelligence handler to produce, parse and report Quality Intelligence from the test suite
class QualityIntelligence
  ...
  def initialize
    ...
    @prometheus_handler = PrometheusHandler.new(ENV.fetch('PROMETHEUS_URL', nil))
