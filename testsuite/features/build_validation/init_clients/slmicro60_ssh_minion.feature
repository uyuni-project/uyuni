...
Feature: Bootstrap a SL Micro 6.0 Salt SSH minion

  Scenario: Clean up sumaform leftovers on a SL Micro SSH 6.0 SSH minion
    When I perform a full salt minion cleanup on "slmicro60_ssh_minion"

  Scenario: Log in as admin user
    Given I am authorized for the "Admin" section

  Scenario: Bootstrap a SL Micro 6.0 SSH minion
...
@proxy
  Scenario: Check registration on proxy of SL Micro 6.0 SSH minion
