...
import com.redhat.rhn.domain.channel.ChannelFamilyTest;
...
public class SUSEProductTestUtils extends HibernateFactory {
    ...
    public static void createVendorSUSEProducts() {
        ...
        if (cfsles == null) {
            ...
            cfsles = TestUtils.saveAndFlush(cfsles);
        }
        ...
        if (cfha == null) {
            ...
            cfha = TestUtils.saveAndFlush(cfha);
        }
        ...
        if (cfslem == null) {
            ...
            cfslem = TestUtils.saveAndFlush(cfslem);
        }
        ...
        if (cfSlesSap == null) {
            ...
            cfSlesSap = TestUtils.saveAndFlush(cfSlesSap);
        }
    ...
    public static void createSUMAToolsProduct() {
        ...
        if (toolsChannelFamily == null) {
            ...
            toolsChannelFamily = TestUtils.saveAndFlush(toolsChannelFamily);
        }
    ...
    public static void createVendorSUSEProductEnvironment(User admin, String testDataPath, boolean withRepos,
        ...
        if (testDataPath == null) {
            testDataPath = "/com/redhat/rhn/manager/content/";
        }
    ...
    public static void clearAllProducts() {
        ...
        session.createMutationQuery("DELETE FROM SUSEProductChannel").executeUpdate();
        session.createMutationQuery("DELETE FROM SUSEProduct").executeUpdate();
        session.createMutationQuery("DELETE FROM SUSEProductExtension").executeUpdate();
    }
