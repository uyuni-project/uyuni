...
public class ProxyConfigUpdateInitializerTest extends JMockBaseTestCaseWithUser {
    ...
    public void testSuccessWhenExistingProxy() {
        ...
        ProxyConfigUpdateContext proxyConfigUpdateContext = createContext();
    ...
    public void testSuccessWhenEntitlementAddedToServer() {
        ...
        ProxyConfigUpdateContext proxyConfigUpdateContext = createContext(mockSystemEntitlementManager);
    ...
    /**
     * Helper method to create ProxyConfigUpdateContext with default system entitlement manager
     * @return the created context
     */
    private ProxyConfigUpdateContext createContext() {
        return createContext(systemEntitlementManager);
    }

    /**
     * Helper method to create ProxyConfigUpdateContext with custom system entitlement manager
     * @param customManager the custom system entitlement manager
     * @return the created context
     */
    private ProxyConfigUpdateContext createContext(SystemEntitlementManager customManager) {
        ProxyConfigUpdateContext proxyConfigUpdateContext =
                new ProxyConfigUpdateContext(null, null, customManager, user, null);
        proxyConfigUpdateContext.setProxyMinion(mockMinionServer);
