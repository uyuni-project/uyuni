...
public class SaltConstants {
    ...
    public static final String SUMA_STATE_FILES_ROOT_PATH =
            ConfigDefaults.get().getSharedServiceDir() + "/susemanager/salt";

    public static final String SUMA_PILLAR_DATA_PATH =
            ConfigDefaults.get().getSharedServiceDir() + "/susemanager/pillar_data";

    public static final String SUMA_PILLAR_IMAGES_DATA_PATH =
            ConfigDefaults.get().getSharedServiceDir() + "/susemanager/pillar_data/images";

    public static final String SALT_FILE_GENERATION_TEMP_PATH =
            ConfigDefaults.get().getSharedServiceDir() + "/susemanager/tmp";
    ...
    public static final String LEGACY_STATES_BACKUP =
            ConfigDefaults.get().getSharedServiceDir() + "/susemanager/legacy_states";
