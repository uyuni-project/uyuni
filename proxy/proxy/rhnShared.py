    ...
    def _connectToParent(self):
        ...
        try:
            ...
            raise_with_tb(rhnFault(1000,
                                   _("SUSE Multi-Linux Manager Proxy could not successfully connect its SUSE Multi-Linux Manager parent. "
    ...
    def _serverCommo(self):
        ...
        try:
            ...
            raise_with_tb(rhnFault(1000, _(
                "SUSE Multi-Linux Manager Proxy error: connection with the SUSE Multi-Linux Manager server failed")), sys.exc_info()[2])
