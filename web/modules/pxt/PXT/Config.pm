...
sub master_configs {
  ...
  my @configs = ("/usr/share/rhn/config-defaults/rhn_$self->{domain}.conf");
  push @configs, "/usr/share/rhn/config-defaults/rhn.conf" if -f "/usr/share/rhn/config-defaults/rhn.conf";
