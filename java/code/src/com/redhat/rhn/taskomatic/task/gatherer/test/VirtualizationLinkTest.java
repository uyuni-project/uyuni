...
public class VirtualizationLinkTest extends BaseTestCaseWithUser {
    ...
    public void testLinking() throws Exception {
        FileReader fr = new FileReader(TestUtils.findTestData("gatherer.out.json").getPath());
        ...
        vms.put("49737e0a-c9e6-4ceb-aef8-6a9452f67cb5", "4230c60f-3f98-2a65-f7c3-600b26b79c22");
        vms.put("5a2e4e63-a957-426b-bfa8-4169302e4fdb", "42307b15-1618-0595-01f2-427ffcddd88e");
