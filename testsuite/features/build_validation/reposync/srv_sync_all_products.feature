...
Feature: Synchronize products in the products page of the Setup Wizard
  ...
  Scenario: SUSE Manager Proxy 4.0 x86_64
    Given I am on the Products page
    When I enter "SUSE Manager Proxy 4.0 x86_64" as the filtered product description
  ...
  Scenario: SUSE Manager Retail Branch Server 4.0 x86_64
    Given I am on the Products page
    When I enter "SUSE Manager Retail Branch Server 4.0 x86_64" as the filtered product description
    ...
    When I click the Add Product button
    And I wait until I see "SUSE Manager Retail Branch Server 4.0 x86_64" product has been added
