 ...
 * @version $Rev$
 */
public class CobblerPowerOnCommandTest extends BaseTestCaseWithUser {
    ...
    public void testStore() throws Exception {
        ...
        ValidatorError error = new CobblerPowerOnCommand(user, server).store();
        ...
        assertNull(new CobblerPowerOnCommand(user, server).store());
        ...
        assertEquals("power_system on " + systemRecord.getId(),
