...
public class RegistryCredentials extends PasswordBasedCredentials {
    ...
    protected RegistryCredentials(String usernameIn, String passwordIn) {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            .append("id", getId())
            .append("type", CredentialsType.REGISTRY)
            .append("user", getUser())
