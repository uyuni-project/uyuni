...
@centos_minion
  Scenario: Prepare a CentOS 7 traditional client
    ...
    When I enable repository "Devel_Galaxy_Manager_3.2_RES-Manager-Tools-7-x86_64" on this "ceos-traditional-client"
    ...
    And  I install package "rhn-client-tools rhn-check rhn-setup rhnsd osad rhncfg-actions" on this "ceos-traditional-client"
