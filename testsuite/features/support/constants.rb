...
PACKAGE_BY_CLIENT ||= {
  ...
  opensuse153arm_minion: 'bison'
}.freeze

BASE_CHANNEL_BY_CLIENT ||= {
  proxy: 'SLE-Product-SUSE-Manager-Proxy-4.2-Pool',
  ...
  opensuse153arm_minion: 'openSUSE Leap 15.3 (aarch64)'
}.freeze

LABEL_BY_BASE_CHANNEL ||= {
  'SLE-Product-SUSE-Manager-Proxy-4.2-Pool': 'sle-product-suse-manager-proxy-4.2-pool-x86_64',
  ...
  'openSUSE Leap 15.3 (aarch64)': 'opensuse_leap15_3-aarch64'
}.freeze

CHANNEL_TO_SYNC_BY_BASE_CHANNEL ||= {
  'SLE-Product-SUSE-Manager-Proxy-4.2-Pool': 'SUMA-42-PROXY-x86_64',
  ...
  'openSUSE Leap 15.3 (aarch64)': 'openSUSE-Leap-15.3-aarch64-uyuni'
}.freeze

PARENT_CHANNEL_TO_SYNC_BY_BASE_CHANNEL ||= {
  'SLE-Product-SUSE-Manager-Proxy-4.2-Pool': 'sle-product-suse-manager-proxy-4.2-pool-x86_64',
  'SLES11-SP3-Pool': nil,
  'SLES11-SP4-Pool': nil,
  'SLES12-SP4-Pool': nil,
  ...
  'debian-10-pool': 'debian-10-pool-amd64',
  'debian-11-pool': 'debian-11-pool-amd64',
  'openSUSE Leap 15.3 (aarch64)': nil 
}.freeze
