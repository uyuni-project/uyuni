...
@proxy
  ...
  Scenario: Check the migration is successful for this minion
    ...
    Then I wait until I see "SUSE Linux Enterprise Server 15 SP2" text, refreshing the page
    And vendor change should be enabled for SP migration on "sle_minion"
