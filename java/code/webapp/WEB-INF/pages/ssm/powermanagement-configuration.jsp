...
<html>
  <body>
    ...
    <rhn:toolbar base="h2" icon="header-power" helpUrl="/rhn/help/user/en-US/s1-sm-systems.jsp#s5-sdc-provisioning-powermgnt">
      <bean:message key="ssm.provisioning.powermanagement.configuration.header"/>
    </rhn:toolbar>
    <div class="page-summary">
      <p><bean:message key="ssm.provisioning.powermanagement.configuration.summary"/></p>
    </div>
    ...
    <c:if test="${fn:length(types) >= 1}">
      ...
      <html:form styleClass="form-horizontal" action="/systems/ssm/provisioning/PowerManagementConfiguration.do">
