...
- [ ] Send the email informing that the branch `Manager-X.Y` is locked and adjust the topic on the slack channel
...
- [ ] Send the email informing that the branch `Manager-X.Y` is unlocked and adjust the topic on the slack channel
