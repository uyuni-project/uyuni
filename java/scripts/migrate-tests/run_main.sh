...
git apply "$THIS_SCRIPTPATH/first_preliminary_step_fix_test_resource_dirs_in_test_code.patch"
git apply "$THIS_SCRIPTPATH/second_preliminary_step_fix_test_resource_dirs_in_test_code.patch"
