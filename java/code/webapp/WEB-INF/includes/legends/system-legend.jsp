...
<div class="sideleg">
  ...
  <li><rhn:icon type="actions-pending" /><bean:message key="system-legend.jsp.pending"/></li>
  ...
  <li><i class="fa fa-square-o fa-1-5x"></i><bean:message key="systemlist.jsp.bootstrap"/></li>
 </ul>
</div>
