...
export function VirtualPortFields(props: Props) {
  ...
  return (
    <>
      ...
      { (props.type === "openvswitch" || (props.type === "802.1qbh" && model['virtualport-params-type'] === "profileid")) && (
        <Text
      ...
      { props.type === "802.1qbh" && model['virtualport-params-type'] === "vsi" && (
        <>
          <Text
            name="virtualport_managerid"
            label={t('VSI manager id')}
            labelClass="col-md-3"
            divClass="col-md-6"
          />
          <Text
            name="virtualport_typeid"
            label={t('VSI type id')}
            labelClass="col-md-3"
            divClass="col-md-6"
          />
