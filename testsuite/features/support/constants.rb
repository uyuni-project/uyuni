...
ENV_VAR_BY_HOST = {
  ...
  'sle15sp6_client' => 'SLE15SP6_CLIENT',
  'sle15sp6_ssh_minion' => 'SLE15SP6_SSHMINION',
  'sle15sp7_client' => 'SLE15SP7_CLIENT',
  ...
  'SUSE Manager' => {
    ...
    'sles15-sp7' =>
      %w[
        ...
        sle-manager-tools15-updates-x86_64-sp7
        sle-manager-tools15-pool-x86_64-sp7
    ...
    'suma-retail-branch-server-43' => # CHECKED
      %w[
        ...
        sle-module-containers15-sp4-pool-x86_64-smrbs-4.3
        sle-module-containers15-sp4-updates-x86_64-smrbs-4.3
...
TIMEOUT_BY_CHANNEL_NAME = {
  ...
  'sle-manager-tools15-pool-x86_64-sp7' => 60,
  ...
  'sle-module-server-applications15-sp4-pool-x86_64-proxy-4.3' => 60,
  ...
  'sle-product-suse-manager-proxy-4.3-updates-x86_64' => 90,
  'sle-product-suse-manager-retail-branch-server-4.3-pool-x86_64' => 60,
  'sle-product-suse-manager-retail-branch-server-4.3-updates-x86_64' => 90,
  ...
  'sl-micro-6.1-devel-uyuni-client-x86_64' => 60,
