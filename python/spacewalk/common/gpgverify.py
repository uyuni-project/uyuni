...
Path: typing.TypeAlias = typing.Union[str, os.PathLike[str]]
...
class Signature(typing.NamedTuple):
    ...
    status: typing.Union[
        typing.Literal["GOOD"],
        typing.Literal["BAD"],
        typing.Literal["EXPIRED"],
        typing.Literal["KEY_EXPIRED"],
        typing.Literal["KEY_REVOKED"],
