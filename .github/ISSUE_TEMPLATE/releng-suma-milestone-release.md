...
- [ ] The PO must provide the release notes for the Beta announcement. REs can provide support as needed, to improve the announcement.
...
- [ ] Wait a couple of hours, ask to release the announcement, and announce to the suse-manager@suse.de and galaxy-devel@suse.de mailing lists.
