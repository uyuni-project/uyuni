...
Feature: Bootstrap a SLES 12 SP4 Salt build host via the GUI
  ...
  Scenario: Check connection from SLES 12 SP4 build host to proxy
    Given I am on the Systems overview page of this "sle12sp4_buildhost"
    When I follow "Details" in the content area
    And I follow "Connection" in the content area
    Then I should see "proxy" short hostname

  Scenario: Check registration on SLES 12 SP4 build host of minion
    Given I am on the Systems overview page of this "proxy"
    When I follow "Details" in the content area
    And I follow "Proxy" in the content area
    Then I should see "sle12sp4_buildhost" hostname

  Scenario: Detect latest Salt changes on the SLES 12 SP4 build host
    When I query latest Salt changes on "sle12sp4_buildhost"

  Scenario: Turn the SLES 12 SP4 build host into a OS image build host
    Given I am on the Systems overview page of this "sle12sp4_buildhost"
    When I follow "Details" in the content area
  ...
  Scenario: Apply the highstate to the SLES 12 SP4 build host
    Given I am on the Systems overview page of this "sle12sp4_buildhost"
    When I wait until no Salt job is running on "sle12sp4_buildhost"
    And I apply highstate on "sle12sp4_buildhost"
    And I wait until event "Apply highstate scheduled by admin" is completed

  Scenario: Check that SLES 12 SP4 build host is now a build host
    Given I am on the Systems overview page of this "sle12sp4_buildhost"
    Then I should see a "[OS Image Build Host]" text

  Scenario: Check events history for failures on SLES 12 SP4 build host
    Given I am on the Systems overview page of this "sle12sp4_buildhost"
