 ...
 */
package com.redhat.rhn.frontend.action.user; import static org.junit.jupiter.api.Assertions.*;
 ...
 * @version $Rev$
 */
public class ExtAuthSgDeleteAction extends RhnAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm formIn,
        ...
        OrgUserExtGroup extGroup = UserGroupFactory.lookupOrgExtGroupByIdAndOrg(gid, org);
