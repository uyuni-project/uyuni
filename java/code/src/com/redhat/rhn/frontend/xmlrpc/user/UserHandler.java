...
public class UserHandler extends BaseHandler {
     ...
     */
    @ReadOnly
    public List<? extends User> listUsers(User loggedInUser) throws FaultException {
    ...
    private Set<String> getAssignableRoles(User user) {
        ...
        if (user.hasRole(RoleFactory.SAT_ADMIN)) {
            ...
            // Regular users can assign only the roles that they are assigned
            rbacRoles = user.getAccessGroups().stream();
        }
