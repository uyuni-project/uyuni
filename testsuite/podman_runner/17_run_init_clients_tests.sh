#!/bin/bash
set -xe
sudo -i podman exec -ti sle_minion bash -c "echo DEBUG MGRPUSH 17 init;rpm -q mgr-push;mgrpush -h"
sudo -i podman exec -ti sle_minion bash -c "echo DEBUG MGRPUSH 17 init 2;rpm -q mgr-push;mgrpush -h"
...
sudo -i podman exec -ti sle_minion bash -c "echo DEBUG MGRPUSH 17 end;rpm -q mgr-push;mgrpush -h"
exit -1
