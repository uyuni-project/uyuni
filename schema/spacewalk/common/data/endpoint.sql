...
INSERT INTO access.endpoint (class_method, endpoint, http_method, scope, auth_required)
    ...
    ON CONFLICT (endpoint, http_method) DO NOTHING;
INSERT INTO access.endpoint (class_method, endpoint, http_method, scope, auth_required)
    VALUES ('com.redhat.rhn.frontend.xmlrpc.audit.CVEAuditHandler.listAffectedSystems', '/manager/api/audit/listAffectedSystems', 'GET', 'A', True)
    ON CONFLICT (endpoint, http_method) DO NOTHING;
INSERT INTO access.endpoint (class_method, endpoint, http_method, scope, auth_required)
    VALUES ('com.redhat.rhn.frontend.xmlrpc.audit.CVEAuditHandler.listAffectedSystemsByCve', '/manager/api/audit/listAffectedSystemsByCve', 'GET', 'A', True)
    ON CONFLICT (endpoint, http_method) DO NOTHING;
INSERT INTO access.endpoint (class_method, endpoint, http_method, scope, auth_required)
