...
@sle12sp5_minion
  Scenario: The SLES 12 SP5 minion is healthy
    ...
    And the "sle12sp5_minion" host should communicate with the server using public interface
...
@sle15sp1_minion
  Scenario: The SLES 15 SP1 minion is healthy
    ...
    And the "sle15sp1_minion" host should communicate with the server using public interface
...
@sle15sp1_ssh_minion
  Scenario: The SLES 15 SP1 Salt SSH minion is healthy
    ...
    And the "sle15sp1_ssh_minion" host should communicate with the server using public interface
...
@sle15sp2_minion
  Scenario: The SLES 15 SP2 minion is healthy
    ...
    And the "sle15sp2_minion" host should communicate with the server using public interface
...
@sle15sp2_ssh_minion
  Scenario: The SLES 15 SP2 Salt SSH minion is healthy
    ...
    And the "sle15sp2_ssh_minion" host should communicate with the server using public interface
...
@sle15sp3_minion
  Scenario: The SLES 15 SP3 minion is healthy
    ...
    And the "sle15sp3_minion" host should communicate with the server using public interface
...
@sle15sp3_ssh_minion
  Scenario: The SLES 15 SP3 Salt SSH minion is healthy
    ...
    And the "sle15sp3_ssh_minion" host should communicate with the server using public interface
...
@sle15sp4_minion
  Scenario: The SLES 15 SP4 minion is healthy
    ...
    And the "sle15sp4_minion" host should communicate with the server using public interface
...
@sle15sp4_ssh_minion
  Scenario: The SLES 15 SP4 Salt SSH minion is healthy
    ...
    And the "sle15sp4_ssh_minion" host should communicate with the server using public interface
...
@sle15sp5_minion
  Scenario: The SLES 15 SP5 minion is healthy
    ...
    And the "sle15sp5_minion" host should communicate with the server using public interface
    And the clock from "sle15sp4_minion" should be exact
...
@sle15sp5_ssh_minion
  Scenario: The SLES 15 SP5 Salt SSH minion is healthy
    ...
    And the "sle15sp5_ssh_minion" host should communicate with the server using public interface
...
@slemicro51_minion
  Scenario: The SLE Micro 5.1 minion is healthy
    ...
    And the "slemicro51_minion" host should communicate with the server using public interface
...
@slemicro51_ssh_minion
  Scenario: The SLE Micro 5.1 SSH minion is healthy
    ...
    And the "slemicro51_ssh_minion" host should communicate with the server using public interface
...
@slemicro52_minion
  Scenario: The SLE Micro 5.2 minion is healthy
    ...
    And the "slemicro52_minion" host should communicate with the server using public interface
...
@slemicro52_ssh_minion
  Scenario: The SLE Micro 5.2 SSH minion is healthy
    ...
    And the "slemicro52_ssh_minion" host should communicate with the server using public interface
...
@slemicro53_minion
  Scenario: The SLE Micro 5.3 minion is healthy
    ...
    And the "slemicro53_minion" host should communicate with the server using public interface
...
@slemicro53_ssh_minion
  Scenario: The SLE Micro 5.3 SSH minion is healthy
    ...
    And the "slemicro53_ssh_minion" host should communicate with the server using public interface
...
@slemicro54_minion
  Scenario: The SLE Micro 5.4 minion is healthy
    ...
    And the "slemicro54_minion" host should communicate with the server using public interface
...
@slemicro54_ssh_minion
  Scenario: The SLE Micro 5.4 SSH minion is healthy
    ...
    And the "slemicro54_ssh_minion" host should communicate with the server using public interface
...
@slemicro55_minion
  Scenario: The SLE Micro 5.5 minion is healthy
    ...
    And the "slemicro55_minion" host should communicate with the server using public interface
...
@slemicro55_ssh_minion
  Scenario: The SLE Micro 5.5 SSH minion is healthy
    ...
    And the "slemicro55_ssh_minion" host should communicate with the server using public interface
...
@alma8_minion
  Scenario: The Alma 8 Salt minion is healthy
    ...
    And the "alma8_minion" host should communicate with the server using public interface
...
@alma8_ssh_minion
  Scenario: The Alma 8 Salt SSH minion is healthy
    ...
    And the "alma8_ssh_minion" host should communicate with the server using public interface
...
@alma9_minion
  Scenario: The Alma 9 Salt minion is healthy
    ...
    And the "alma9_minion" host should communicate with the server using public interface
...
@alma9_ssh_minion
  Scenario: The Alma 9 Salt SSH minion is healthy
    ...
    And the "alma9_ssh_minion" host should communicate with the server using public interface
...
@centos7_minion
  Scenario: The CentOS 7 Salt minion is healthy
    ...
    And the "centos7_minion" host should communicate with the server using public interface
...
@centos7_ssh_minion
  Scenario: The CentOS 7 Salt SSH minion is healthy
    ...
    And the "centos7_ssh_minion" host should communicate with the server using public interface
...
@liberty9_minion
  Scenario: The Liberty 9 Salt minion is healthy
    ...
    And the "liberty9_minion" host should communicate with the server using public interface
...
@liberty9_ssh_minion
  Scenario: The Liberty 9 Salt SSH minion is healthy
    ...
    And the "liberty9_ssh_minion" host should communicate with the server using public interface
...
@oracle9_minion
  Scenario: The Oracle 9 Salt minion is healthy
    ...
    And the "oracle9_minion" host should communicate with the server using public interface
...
@oracle9_ssh_minion
  Scenario: The Oracle 9 Salt SSH minion is healthy
    ...
    And the "oracle9_ssh_minion" host should communicate with the server using public interface
...
@rhel9_minion
  Scenario: The Red Hat Linux 9 Salt minion is healthy
    ...
    And the "rhel9_minion" host should communicate with the server using public interface
...
@rhel9_ssh_minion
  Scenario: The Red Hat Linux 9 SSH minion is healthy
    ...
    And the "rhel9_ssh_minion" host should communicate with the server using public interface
...
@rocky8_minion
  Scenario: The Rocky 8 Salt minion is healthy
    ...
    And the "rocky8_minion" host should communicate with the server using public interface
...
@rocky8_ssh_minion
  Scenario: The Rocky 8 Salt SSH minion is healthy
    ...
    And the "rocky8_ssh_minion" host should communicate with the server using public interface
...
@rocky9_minion
  Scenario: The Rocky 9 Salt minion is healthy
    ...
    And the "rocky9_minion" host should communicate with the server using public interface
...
@rocky9_ssh_minion
  Scenario: The Rocky 9 Salt SSH minion is healthy
    ...
    And the "rocky9_ssh_minion" host should communicate with the server using public interface
...
@ubuntu2004_minion
  Scenario: The Ubuntu 20.04 minion is healthy
    ...
    And the "ubuntu2004_minion" host should communicate with the server using public interface
...
@ubuntu2004_ssh_minion
  Scenario: The Ubuntu 20.04 Salt SSH minion is healthy
    ...
    And the "ubuntu2004_ssh_minion" host should communicate with the server using public interface
...
@ubuntu2204_minion
  Scenario: The Ubuntu 22.04 minion is healthy
    ...
    And the "ubuntu2204_minion" host should communicate with the server using public interface
...
@ubuntu2204_ssh_minion
  Scenario: The Ubuntu 22.04 Salt SSH minion is healthy
    ...
    And the "ubuntu2204_ssh_minion" host should communicate with the server using public interface
...
@debian10_minion
  Scenario: The Debian 10 minion is healthy
    ...
    And the "debian10_minion" host should communicate with the server using public interface
...
@debian10_ssh_minion
  Scenario: The Debian 10 Salt SSH minion is healthy
    ...
    And the "debian10_ssh_minion" host should communicate with the server using public interface
...
@debian11_minion
  Scenario: The Debian 11 minion is healthy
    ...
    And the "debian11_minion" host should communicate with the server using public interface
...
@debian11_ssh_minion
  Scenario: The Debian 11 Salt SSH minion is healthy
    ...
    And the "debian11_ssh_minion" host should communicate with the server using public interface
...
@debian12_minion
  Scenario: The Debian 12 minion is healthy
    ...
    And the "debian12_minion" host should communicate with the server using public interface
...
@debian12_ssh_minion
  Scenario: The Debian 12 Salt SSH minion is healthy
    ...
    And the "debian12_ssh_minion" host should communicate with the server using public interface
...
@opensuse154arm_minion
  Scenario: The openSUSE 15.4 ARM minion is healthy
    ...
    And the "opensuse154arm_minion" host should communicate with the server using public interface
...
@opensuse154arm_ssh_minion
  Scenario: The openSUSE 15.4 ARM SSH minion is healthy
    ...
    And the "opensuse154arm_ssh_minion" host should communicate with the server using public interface
...
@opensuse155arm_minion
  Scenario: The openSUSE 15.5 ARM minion is healthy
    ...
    And the "opensuse155arm_minion" host should communicate with the server using public interface
...
@opensuse155arm_ssh_minion
  Scenario: The openSUSE 15.5 ARM SSH minion is healthy
    ...
    And the "opensuse155arm_ssh_minion" host should communicate with the server using public interface
...
@sle15sp5s390_minion
  Scenario: The SLES 15 SP5 s390x minion is healthy
    ...
    And the "sle15sp5s390_minion" host should communicate with the server using public interface
...
@sle15sp5s390_ssh_minion
  Scenario: The SLES 15 SP5 s390x SSH minion is healthy
    ...
    And the "sle15sp5s390_ssh_minion" host should communicate with the server using public interface
...
@sle12sp5_buildhost
  Scenario: The SLES 12 SP5 build host is healthy
    ...
    And the "sle12sp5_buildhost" host should communicate with the server using public interface
...
@sle15sp4_buildhost
  Scenario: The SLES 15 SP4 build host is healthy
    ...
    And the "sle15sp4_buildhost" host should communicate with the server using public interface
...
@monitoring_server
  Scenario: The monitoring server is healthy
    ...
    And the "monitoring_server" host should communicate with the server using public interface
