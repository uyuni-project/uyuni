...
Feature: PXE boot a terminal with Cobbler
  ...
  Scenario: Fix kernel parameters
    ...
    And I enter "useonlinerepo insecure=1 install=http://proxy.example.org/ks/dist/SLE-15-SP3-TFTP self_update=http://proxy.example.org/ks/dist/child/sle15-sp3-installer-updates-x86_64/SLE-15-SP3-TFTP" as "kernelopts"
  ...
  Scenario: Cleanup: remove TFTP boot package from the server
    And I remove package "tftpboot-installation-SLE-15-SP3-x86_64" from this "server" without error control
