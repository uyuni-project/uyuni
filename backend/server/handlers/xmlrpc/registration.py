...
##                 }
    ...
    def attempt_eol_mailing(self, user, server):
        ...
        if user.info.has_key("email"):
            ...
            headers = {}
            headers['From'] = 'Red Hat Network [GALAXY] <dev-null@rhn.redhat.com>'
            headers['To'] = user.info['email']
            headers['Subject'] = 'End of Life RHN Channel Subscription [GALAXY]'
...
EOL_EMAIL = """
Dear Red Hat Network [GALAXY] User,

This email has been autogenerated to alert you that you recently subscribed the
following system to an RHN [GALAXY] channel related to a Red Hat Linux [GALAXY] distribution that
...
For more information regarding Red Hat Linux [GALAXY] support, please go to:

http://www.redhat.com/apps/support/errata/  [GALAXY]

If you are interested in a distribution of Red Hat [GALAXY] with a longer release
lifecycle, 5+ year maintenance period, ISV support, and enhanced functionality,
check out Red Hat Enterprise Linux [GALAXY] at:

http://www.redhat.com/software/rhel/  [GALAXY]


Thank you for using Red Hat Network  [GALAXY].
"""
