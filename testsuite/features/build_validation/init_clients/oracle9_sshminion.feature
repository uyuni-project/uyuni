...
Feature: Bootstrap a Oracle 9 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on a Oracle 9 Salt SSH minion
    When I perform a full salt minion cleanup on "oracle9_sshminion"
  ...
  Scenario: Bootstrap a Oracle 9 Salt SSH minion
    ...
    And I enter the hostname of "oracle9_sshminion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-oracle9_sshminion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "oracle9_sshminion"

@proxy
  Scenario: Check connection from Oracle 9 Salt SSH minion to proxy
    Given I am on the Systems overview page of this "oracle9_sshminion"
...
@proxy
  Scenario: Check registration on proxy of Oracle 9 Salt SSH minion
    ...
    Then I should see "oracle9_sshminion" hostname

@monitoring_server
  Scenario: Prepare Oracle 9 Salt SSH minion firewall for monitoring
    When I enable firewall ports for monitoring on this "oracle9_sshminion"
