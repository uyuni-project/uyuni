...
@centosminion
  Scenario: Prepare a CentOS 7 traditional client
     ...
     And  I run "sed s/enabled=.*/enabled=1/g /etc/yum.repos.d/Devel_Galaxy_Manager_3.1_RES-Manager-Tools-7-x86_64.repo  -i" on "ceos-traditional-client" without error control
