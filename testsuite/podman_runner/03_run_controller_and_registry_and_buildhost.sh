...
# sudo docker pull ghcr.io/$UYUNI_PROJECT/uyuni/opensuse/leap/15.4:master
# sudo docker tag ghcr.io/$UYUNI_PROJECT/uyuni/opensuse/leap/15.4:master localhost:5002/opensuse/leap:15.4
# sudo docker push localhost:5002/opensuse/leap:15.4
