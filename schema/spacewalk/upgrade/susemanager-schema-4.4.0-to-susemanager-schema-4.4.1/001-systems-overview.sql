...
CREATE TABLE IF NOT EXISTS suseSystemOverview (
...
SELECT sequence_nextval('rhn_tasko_task_id_seq'), 'system-overview-update-queue', 'com.redhat.rhn.taskomatic.task.SystemOverviewUpdateQueue'
WHERE NOT EXISTS (SELECT 1 FROM rhnTaskoTask WHERE name = 'system-overview-update-queue');

INSERT INTO rhnTaskoTask (id, name, class)
SELECT sequence_nextval('rhn_tasko_task_id_seq'), 'update-system-overview', 'com.redhat.rhn.taskomatic.task.SystemOverviewUpdateTask'
WHERE NOT EXISTS (SELECT 1 FROM rhnTaskoTask WHERE name = 'update-system-overview');

INSERT INTO rhnTaskoBunch (id, name, description, org_bunch)
SELECT sequence_nextval('rhn_tasko_bunch_id_seq'), 'system-overview-update-queue-bunch', 'Process system overview update requests', null
WHERE NOT EXISTS (SELECT 1 FROM rhnTaskoBunch WHERE name = 'system-overview-update-queue-bunch');

INSERT INTO rhnTaskoBunch (id, name, description, org_bunch)
SELECT sequence_nextval('rhn_tasko_bunch_id_seq'), 'update-system-overview-bunch', 'Update the DB table gathering the systems data to show in lists', null
WHERE NOT EXISTS (SELECT 1 FROM rhnTaskoBunch WHERE name = 'update-system-overview-bunch');
...
WHERE NOT EXISTS (
    ...
    WHERE bunch_id = (SELECT id FROM rhnTaskoBunch WHERE name = 'system-overview-update-queue-bunch')
      AND task_id = (SELECT id FROM rhnTaskoTask WHERE name = 'system-overview-update-queue')
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM rhnTaskoTemplate
    WHERE bunch_id = (SELECT id FROM rhnTaskoBunch WHERE name = 'update-system-overview-bunch')
      AND task_id = (SELECT id FROM rhnTaskoTask WHERE name = 'update-system-overview')
);

INSERT INTO rhnTaskoSchedule (id, job_label, bunch_id, active_from, cron_expr)
SELECT sequence_nextval('rhn_tasko_schedule_id_seq'), 'system-overview-update-queue-default',
    (SELECT id FROM rhnTaskoBunch WHERE name='system-overview-update-queue-bunch'),
    current_timestamp, '0 * * * * ?'
WHERE NOT EXISTS (SELECT 1 FROM rhnTaskoSchedule WHERE job_label = 'system-overview-update-queue-default');

INSERT INTO rhnTaskoSchedule (id, job_label, bunch_id, active_from, cron_expr)
SELECT sequence_nextval('rhn_tasko_schedule_id_seq'), 'update-system-overview-default',
    (SELECT id FROM rhnTaskoBunch WHERE name='update-system-overview-bunch'),
    current_timestamp, '0 0 * * * ?'
WHERE NOT EXISTS (SELECT 1 FROM rhnTaskoSchedule WHERE job_label = 'update-system-overview-default');
