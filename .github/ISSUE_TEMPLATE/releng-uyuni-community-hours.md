...
- [ ] Check that the slack workflow with the reminder has the right text
- [ ] Check that the [community calendar](https://calendar.opensuse.org/teams/uyuni/events/uyuni-community-hours) has the right date/time
- [ ] Prepare slides
...
- [ ] Prepare the text for the announcements ([see this as example](https://github.com/SUSE/spacewalk/issues/21252))
  ...
  - [ ] X (first tweet, reminder, published recording)
