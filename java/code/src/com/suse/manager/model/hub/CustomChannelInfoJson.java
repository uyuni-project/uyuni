...
public class CustomChannelInfoJson {
    ...
    public Date getLastSyncedDate() {
        return longToDate(lastSyncedDate);
    }

    /**
     * @param lastSyncedDateIn The lastSynced to set.
     */
    public void setLastSyncedDate(Date lastSyncedDateIn) {
        this.lastSyncedDate = dateToLong(lastSyncedDateIn);
    }
    ...
    public boolean equals(Object oIn) {
        if (!(oIn instanceof CustomChannelInfoJson that)) {
            return false;
        }
        return isGpgCheck() == that.isGpgCheck() &&
                isInstallerUpdates() == that.isInstallerUpdates() &&
                ...
                Objects.equals(getLastSyncedDate(), that.getLastSyncedDate()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getPeripheralOrgId(), getParentChannelLabel(), getChannelArchLabel(), getLabel(),
                getBaseDir(), getName(), getSummary(), getDescription(), getProductNameLabel(), isGpgCheck(),
                getGpgKeyUrl(), getGpgKeyId(), getGpgKeyFp(), getEndOfLifeDate(), getChecksumTypeLabel(),
                getLastSyncedDate(), getChannelProductProduct(),
                getChannelProductVersion(), getChannelAccess(), getMaintainerName(), getMaintainerEmail(),
                getMaintainerPhone(), getSupportPolicy(), getUpdateTag(), isInstallerUpdates(),
                getOriginalChannelLabel(), getRepositoryInfo());
    }
    ...
    public String toString() {
        ...
        sb.append(", endOfLife=").append(endOfLifeDate);
        sb.append(", checksumTypeLabel='").append(checksumTypeLabel).append('\'');
        sb.append(", lastSynced=").append(lastSyncedDate);
        ...
        sb.append(", originalChannelLabel=").append(originalChannelLabel);
