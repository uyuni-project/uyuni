...
Feature: Migrate a SLES 15 SP2 Salt minion to 15 SP4
  ...
  Scenario: Install the latest Salt on this minion
    When I migrate the non-SUMA repositories on "sle15sp2_minion"
    And I enable repositories before installing Salt on this "sle15sp2_minion"
    And I install Salt packages from "sle15sp2_minion"
    And I disable repositories after installing Salt on this "sle15sp2_minion"
  ...
  Scenario: Check the new channel is working
    When I refresh the metadata for "sle15sp2_minion"

  Scenario: Detect latest Salt changes on the SLES minion
    When I query latest Salt changes on "sle15sp2_minion"
