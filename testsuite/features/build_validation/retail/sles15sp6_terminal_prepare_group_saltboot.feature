...
@proxy
@sles15sp6_terminal
Feature: Prepare prerequisites for SLES 15 SP6 terminal deployment

  Scenario: Log in as admin user
    Given I am authorized for the "Admin" section

  Scenario: Create hardware type group for SLES 15 SP6 terminal
  ...
  Scenario: Enable Saltboot formula for hardware type group SLES 15 SP6 terminal
    When I follow the left menu "Systems > System Groups"
  ...
  Scenario: Parametrize the Saltboot formula SLES 15 SP6 terminal
    When I follow the left menu "Systems > System Groups"
    And I follow "HWTYPE:HP-ProLiantDL360Gen9" in the content area
    And I follow "Formulas" in the content area
    ...
    And I enter the image name for "sles15sp6_terminal" in third OS image field
