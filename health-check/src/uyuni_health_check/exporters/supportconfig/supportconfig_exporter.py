...
def main():
    ...
    logging.info("STARTING SUPPORTCONFIG EXPORTER PROCESS")
    ...
    logging.info("Creating metrics collector object")
    collector = SupportConfigMetricsCollector(supportconfig_path)
    logging.info("Registering collector")
    REGISTRY.register(collector)
    logging.info("Supporconfig Exporter is ready")
    while True:
        # period between collection
        time.sleep(frequency)
        logging.info("Refreshing collector")
        collector.refresh()
