...
@scc_credentials
  Scenario: Create auto installation distribution
    ...
    And I enter "SLE-15-SP2-KVM" as "label"
    ...
    And I should see a "SLE-15-SP2-KVM" link
...
@scc_credentials
  Scenario: Create auto installation profile
    ...
    And I select "SLE-15-SP2-KVM" from "kstreeId"
...
@scc_credentials
  Scenario: Cleanup: remove the auto installation distribution
    ...
    Then I should not see a "SLE-15-SP2-KVM" text
