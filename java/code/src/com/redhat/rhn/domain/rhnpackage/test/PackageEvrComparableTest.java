...
public class PackageEvrComparableTest extends RhnBaseTestCase {
    ...
    public void testDifference() {
        ...
        compare(1, "null-1.27+1.3.9-1", "null-1.27.1+1.3.9-1", PackageType.RPM);
        compare(-1, "null-1.27+1.3.9-1", "null-1.27.1+1.3.9-1", PackageType.DEB);

        compare(1, "null-2-1.27+1.3.9", "null-2-1.27.1+1.3.9", PackageType.RPM);
        compare(-1, "null-2-1.27+1.3.9", "null-2-1.27.1+1.3.9", PackageType.DEB);

        compare(1, "null-8.0.9-1", "null-a.8.0.9-1", PackageType.RPM);
        compare(-1, "null-8.0.9-1", "null-a.8.0.9-1", PackageType.DEB);
}
    ...
    private PackageEvr create(String evr, PackageType type) {
        ...
        return PackageEvrFactory.lookupOrCreatePackageEvr(values[0], values[1], values[2], type);
    }
