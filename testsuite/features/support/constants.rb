...
FIELD_IDS = { 'NIC'                             => 'branch_network#nic',
              ...
              'filename EFI'                    => 'dhcpd#subnets#0#filename_efi',
              ...
              'kernel filename'                 => 'pxe#kernel_name',
              'initrd filename'                 => 'pxe#initrd_name',
              'kernel command line parameters'  => 'pxe#default_kernel_parameters',
              'PXE root directory'              => 'pxe#pxe_root_directory',
              ...
              'first device'                    => 'partitions#devices#0#$key',
              'first Yomi partition number'     => 'partitions#devices#0#partitions#0#number',
              'first Yomi partition size'       => 'partitions#devices#0#partitions#0#size',
              'first Yomi partition type'       => 'partitions#devices#0#partitions#0#type',
              'second Yomi partition number'    => 'partitions#devices#0#partitions#1#number',
              'second Yomi partition size'      => 'partitions#devices#0#partitions#1#size',
              'second Yomi partition type'      => 'partitions#devices#0#partitions#1#type',
              'third Yomi partition number'     => 'partitions#devices#0#partitions#2#number',
              'third Yomi partition size'       => 'partitions#devices#0#partitions#2#size',
              'third Yomi partition type'       => 'partitions#devices#0#partitions#2#type',
              'first filesystem partition'      => 'filesystems#0#$key',
              'first filesystem filesystem'     => 'filesystems#0#filesystem',
              'first filesystem mountpoint'     => 'filesystems#0#mountpoint',
              'second filesystem partition'     => 'filesystems#1#$key',
              'second filesystem filesystem'    => 'filesystems#1#filesystem',
              'second filesystem mountpoint'    => 'filesystems#1#mountpoint',
              'bootloader device'               => 'bootloader#device',
              'bootloader theme'                => 'bootloader#theme',
              'first repository name'           => 'software#repositories#0#0',
              'first repository URL'            => 'software#repositories#0#1',
              'first package'                   => 'software#packages#0',
              'second package'                  => 'software#packages#1',
              'third package'                   => 'software#packages#2',
              'first enabled service'           => 'services#enabled#0#$key',
              'second enabled service'          => 'services#enabled#1#$key',
              'first user name'                 => 'users#0#username',
              'first user password hash'        => 'users#0#password' }.freeze
...
PATCH_BY_CLIENT = { 'ceos6_minion' => 'res6ct-client-tools-202008-16105',
                    'ceos6_ssh_minion' => 'res6ct-client-tools-202008-16105',
                    'ceos6_client' => 'res6ct-client-tools-202008-16105',
                    'ceos7_minion' => 'suse-res7ct-client-tools-202009-16515',
                    'ceos7_ssh_minion' => 'suse-res7ct-client-tools-202009-16515',
                    'ceos7_client' => 'suse-res7ct-client-tools-202009-16515',
                    'sle11sp4_ssh_minion' => 'unzip-13984',
                    'sle11sp4_minion' => 'unzip-13984',
                    'sle11sp4_client' => 'unzip-13984',
                    'sle12sp4_ssh_minion' => 'SUSE-12-SP4-2020-1859',
                    'sle12sp4_minion' => 'SUSE-12-SP4-2020-1859',
                    'sle12sp4_client' => 'SUSE-12-SP4-2020-1859',
                    'sle15_ssh_minion' => 'SUSE-15-2020-16522',
                    'sle15_minion' => 'SUSE-15-2020-16522',
                    'sle15_client' => 'SUSE-15-2020-16522',
                    'sle15sp1_ssh_minion' => 'SUSE-15-SP1-2020-2704',
                    'sle15sp1_minion' => 'SUSE-15-SP1-2020-2704',
                    'sle15sp1_client' => 'SUSE-15-SP1-2020-2704',
                    'sle15sp2_ssh_minion' => 'SUSE-15-SP2-2020-2704',
                    'sle15sp2_minion' => 'SUSE-15-SP2-2020-2704',
                    'sle15sp2_client' => 'SUSE-15-SP2-2020-2704' }.freeze
...
CHANNEL_BY_CLIENT = { 'proxy' => 'SLES15-SP2-Pool',
                      ...
                      'ceos6_minion' => 'RHEL6-Pool for x86_64',
                      'ceos6_ssh_minion' => 'RHEL6-Pool for x86_64',
                      'ceos6_client' => 'RHEL6-Pool for x86_64',
                      'ceos7_minion' => 'RHEL7-Pool for x86_64',
                      'ceos7_ssh_minion' => 'RHEL7-Pool for x86_64',
                      'ceos7_client' => 'RHEL7-Pool for x86_64',
