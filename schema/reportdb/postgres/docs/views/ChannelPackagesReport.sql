...
COMMENT ON COLUMN ChannelPackagesReport.package_name
  IS 'The name of the package';
COMMENT ON COLUMN ChannelPackagesReport.package_version
  IS 'The version number of the package';
COMMENT ON COLUMN ChannelPackagesReport.package_release
  IS 'The release number of the package';
COMMENT ON COLUMN ChannelPackagesReport.package_epoch
  IS 'The epoch of the package';
COMMENT ON COLUMN ChannelPackagesReport.package_arch
