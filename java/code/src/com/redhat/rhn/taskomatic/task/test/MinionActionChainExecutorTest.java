...
public class MinionActionChainExecutorTest extends JMockBaseTestCaseWithUser {
    ...
    public void testRejectsActionChainsWithOldEarliestDate() {
        ...
        context().checking(new Expectations() {{
            ignoring(jobDetail).getJobDataMap();
            will(returnValue(new JobDataMap(Map.of(
            ...
            ignoring(jobDetail).getKey();
            will(returnValue(new JobKey("dummyJob")));

            ignoring(trigger).getJobDataMap();
            will(returnValue(new JobDataMap()));

            ignoring(trigger).getKey();
            will(returnValue(new TriggerKey("dummyTrigger")));

            never(saltServerActionService).executeActionChain(with(any(Long.class)));
        }});
