...
- [ ] Report a new issue for autobuild team with the details of the needed projects at the [release-support board](https://gitlab.suse.de/buildops/release-support/-/issues/new)
  - [ ] ask them to release the images from [SUSE:SLE-15-SP5:Update:Products:Manager50:Update:CR:ToTest](https://build.suse.de/project/show/SUSE:SLE-15-SP5:Update:Products:Manager50:Update:CR:ToTest)
