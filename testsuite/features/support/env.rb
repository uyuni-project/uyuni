...
Before('@centos7_client') do
  skip_this_scenario unless ENV.key? ENV_VAR_BY_HOST['centos7_client']
end
...
Before('@sle15sp3_client') do
  skip_this_scenario unless ENV.key? ENV_VAR_BY_HOST['sle15sp3_client']
end
...
Before('@sle15sp4_client') do
  skip_this_scenario unless ENV.key? ENV_VAR_BY_HOST['sle15sp4_client']
end
...
Before('@sle15sp6_client') do
  skip_this_scenario unless ENV.key? ENV_VAR_BY_HOST['sle15sp6_client']
end
...
Before('@sle15sp7_client') do
  skip_this_scenario unless ENV.key? ENV_VAR_BY_HOST['sle15sp7_client']
end
