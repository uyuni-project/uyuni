...
-- SUSE
insert into rhnPackageKey select sequence_nextval('rhn_pkey_id_seq'), 'a84edae89c800aca', lookup_package_key_type('gpg'), lookup_package_provider('SUSE LINUX Products GmbH') from dual where not exists (select 1 from rhnPackageKey where key_id = 'a84edae89c800aca');

insert into rhnPackageKey select sequence_nextval('rhn_pkey_id_seq'), 'e3a5c360307e3d54', lookup_package_key_type('gpg'), lookup_package_provider('SUSE LINUX Products GmbH') from dual where not exists (select 1 from rhnPackageKey where key_id = 'e3a5c360307e3d54');

insert into rhnPackageKey select sequence_nextval('rhn_pkey_id_seq'), '6c74ce73b37b98a9', lookup_package_key_type('gpg'), lookup_package_provider('SUSE LINUX Products GmbH') from dual where not exists (select 1 from rhnPackageKey where key_id = '6c74ce73b37b98a9');

insert into rhnPackageKey select sequence_nextval('rhn_pkey_id_seq'), '8055f0400182b964', lookup_package_key_type('gpg'), lookup_package_provider('SUSE LINUX Products GmbH') from dual where not exists (select 1 from rhnPackageKey where key_id = '8055f0400182b964');

insert into rhnPackageKey select sequence_nextval('rhn_pkey_id_seq'), '70af9e8139db7c82', lookup_package_key_type('gpg'), lookup_package_provider('SUSE LINUX Products GmbH') from dual where not exists (select 1 from rhnPackageKey where key_id = '70af9e8139db7c82');

insert into rhnPackageKey select sequence_nextval('rhn_pkey_id_seq'), '5eaf444450a3dd1c', lookup_package_key_type('gpg'), lookup_package_provider('SUSE LINUX Products GmbH') from dual where not exists (select 1 from rhnPackageKey where key_id = '5eaf444450a3dd1c');

insert into rhnPackageKey select sequence_nextval('rhn_pkey_id_seq'), 'b88b2fd43dbdc284', lookup_package_key_type('gpg'), lookup_package_provider('openSUSE') from dual where not exists (select 1 from rhnPackageKey where key_id = 'b88b2fd43dbdc284');
