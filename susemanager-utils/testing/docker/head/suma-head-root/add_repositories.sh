...
zypper ar -f http://download.suse.de/ibs/Devel:/Galaxy:/Manager:/Head:/Other/SLE_15_SP2/ "Devel:Galaxy:Manager:Head:Other"
zypper ar -f http://download.suse.de/ibs/Devel:/Galaxy:/Manager:/Head/SLE_15_SP2/ "Devel:Galaxy:Manager:Head"
