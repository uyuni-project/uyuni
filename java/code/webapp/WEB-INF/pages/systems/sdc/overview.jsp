            ...
            <td>
              <c:choose>
                ...
                <c:otherwise>
                  ...
                  <a href="/rhn/manager/contentmanagement/filters?openFilterId=-1&openTemplate=LivePatchingSystem&systemId=${system.id}&systemName=${system.name}&kernelId=0000&kernelName=${system.runningKernel}">(<bean:message key="sdc.details.overview.create_clm_filter"/>)</a>
                </c:otherwise>
              </c:choose>
