...
public class ReportDBCredentials extends PasswordBasedCredentials {

    // No args constructor for hibernate
    protected ReportDBCredentials() {
    }

    // Default constructor filling the mandatory fields to be used in the CredentialFactory
    protected ReportDBCredentials(String usernameIn, String  passwordIn) {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            .append("id", getId())
            .append("type", CredentialsType.REPORT_DATABASE)
            .append("user", getUser())
