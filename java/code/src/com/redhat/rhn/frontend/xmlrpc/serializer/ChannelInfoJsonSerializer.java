 ...
 * #prop_desc("long", "orgId", "the organization id of the channel")
 * #prop_desc("long", "parentChannelId", "the parent channel ID of the channel")
 * #struct_end()
 */
public class ChannelInfoJsonSerializer extends ApiResponseSerializer<ChannelInfoJson> {
    ...
    public SerializedApiResponse serialize(ChannelInfoJson src) {
        return new SerializationBuilder()
                ...
                .add("parentChannelId", src.getParentChannelId())
                .build();
    }
}
