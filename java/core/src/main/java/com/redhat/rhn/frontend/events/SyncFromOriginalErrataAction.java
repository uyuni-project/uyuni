 ...
 */
public class SyncFromOriginalErrataAction implements MessageAction {

    @Override
    public void execute(EventMessage msgIn) {
        SyncFromOriginalErrataEvent msg = (SyncFromOriginalErrataEvent) msgIn;

        SyncFromOriginalService service = new SyncFromOriginalServiceImpl();
