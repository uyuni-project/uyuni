...
def test_format_file_results_utf8(skeleton_row):  #  pylint: disable=redefined-outer-name
...
@patch(get_client_capabilities, my_get_client_capabilities)
@patch(read_lob, my_read_lob)
def test_format_file_results_binary_blob(skeleton_row):  #  pylint: disable=redefined-outer-name
...
@patch(get_client_capabilities, my_get_client_capabilities)
@patch(read_lob, my_read_lob)
def test_format_file_results_latin1(skeleton_row):  #  pylint: disable=redefined-outer-name
