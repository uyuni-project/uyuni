...
BASE_CHANNEL_BY_CLIENT = { 'proxy' => 'SLE-Product-SUSE-Manager-Proxy-4.3-Pool',
                           ...
                           'rocky8_minion' => 'no-appstream-8-result-RHEL8-Pool for x86_64',
                           'rocky8_ssh_minion' => 'no-appstream-8-result-RHEL8-Pool for x86_64',
                           'rocky9_minion' => 'no-appstream-9-result-rockylinux-9 for x86_64',
                           'rocky9_ssh_minion' => 'no-appstream-9-result-rockylinux-9 for x86_64',
...
CHANNEL_TO_SYNC_BY_BASE_CHANNEL = { 'SLE-Product-SUSE-Manager-Proxy-4.3-Pool' => 'SUMA-43-PROXY-x86_64',
                                    ...
                                    'no-appstream-9-result-rockylinux-9 for x86_64' => 'rockylinux-9-x86_64',
...
PARENT_CHANNEL_TO_SYNC_BY_BASE_CHANNEL = { 'SLE-Product-SUSE-Manager-Proxy-4.3-Pool' => 'sle-product-suse-manager-proxy-4.3-pool-x86_64',
                                           ...
                                           'no-appstream-8-result-RHEL8-Pool for x86_64' => nil,
                                           'no-appstream-9-result-rockylinux-9 for x86_64' => nil,
