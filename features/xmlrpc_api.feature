...
Feature: Test XML-RPC "api" namespace.
  ...
  Scenario: Public API test
    ...
    When I call getApiNamespaces, I should get 40 namespaces
    When I call getApiNamespaceCallList, I should get 519 available api calls
    When I call getApiCallList, I should get 40 available groups
