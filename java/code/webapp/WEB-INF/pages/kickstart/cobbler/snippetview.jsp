...
<html:html >
<body>
<script language="javascript" type="text/javascript" src="/javascript/legacy/ace-editor/src-min-noconflict/ace.js?cb=${rhn:getConfig('web.buildtimestamp')}"></script>
<script language="javascript" type="text/javascript" src="/javascript/legacy/ace-editor/src-min-noconflict/ext-modelist.js?cb=${rhn:getConfig('web.buildtimestamp')}"></script>
