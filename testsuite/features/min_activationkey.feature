...
Feature: Bootstrap a Salt minion via the GUI with an activation key
  ...
  Scenario: Turn the SLES minion into a container build host after activation key tests
    Given I am on the Systems overview page of this "sle-minion"
  ...
  Scenario: Apply the highstate to container build host after activation key tests
    Given I am on the Systems overview page of this "sle-minion"
