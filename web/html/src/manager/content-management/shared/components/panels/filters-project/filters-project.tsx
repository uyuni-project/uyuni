...
import { ProjectMessageType, ProjectFilterServerType } from "../../../type/project.type";
...
const renderFilterEntry = (filter, projectId, symbol, last) => {
  ...
  return (
    <>
      <li key={`filter_list_item_${filter.id}`} className={`list-group-item ${styles.wrapper} ${filterClassName}`}>
