...
Feature: PXE boot a SLES 11 SP3 retail terminal
  ...
  Scenario: Configure image-synchronization formula at branch server for SLE11 SP3 terminal deployment
    When I execute "image_sync" for "SLE11 SP3" via semi-xmlrpc-tester
  ...
  Scenario: Install a package on the SLES 11 SP3 retail terminal
    When I follow "Software" in the content area
    And I follow "Install"
    And I enter "gcc" as the filtered package name
    And I check "gcc-4.3" in the list
