...
Feature: Synchronize products in the products page of the Setup Wizard
  ...
  Scenario: Add RHEL8 Base x86_64
    Given I am on the Products page
    And I enter "RHEL8 Base x86_64" as the filtered product description
    And I select "RHEL8 Base x86_64" as a product
    Then I should see the "RHEL8 Base x86_64" selected
    When I click the Add Product button
    And I wait until I see "RHEL8 Base x86_64" product has been added
