            ...
            <%@ taglib uri="http://rhn.redhat.com/rhn" prefix="rhn" %>
                ...
                <body>
                    <%@ include file="/WEB-INF/pages/common/fragments/ssm/header.jspf" %>
                        ...
                        <html:form method="post" action="/systems/ssm/groups/Create.do" styleClass="form-horizontal">
                            <rhn:csrf />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <html:text property="name" size="30" styleId="name" maxlength="64"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <html:textarea property="description" cols="40" styleClass="form-control" rows="4"
                                        styleId="description" />
                                </div>
                            </div>
