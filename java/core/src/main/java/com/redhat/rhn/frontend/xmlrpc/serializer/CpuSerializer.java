 ...
 *      #prop("string", "count")
 *      #prop_desc("int", "socket_count", "if available")
 *      #prop_desc("int", "core_count", "if available, number of cores per socket")
 *      #prop_desc("int", "thread_count", "if available, number of threads per core")
 *  #struct_end()
 *
 */
