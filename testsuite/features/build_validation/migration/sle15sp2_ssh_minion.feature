...
@sle15sp2_ssh_minion
Feature: Migrate a SLES 15 SP2 Salt SSH minion to 15 SP3
  ...
  Scenario: Check the migration is successful for this SSH minion
    ...
    And vendor change should be enabled for product migration on "sle15sp2_ssh_minion"

  Scenario: Install the latest Salt on this SSH minion
    When I migrate the non-SUMA repositories on "sle15sp2_ssh_minion"
    And I enable repositories before installing Salt on this "sle15sp2_ssh_minion"
    And I install Salt packages from "sle15sp2_ssh_minion"
    And I disable repositories after installing Salt on this "sle15sp2_ssh_minion"
