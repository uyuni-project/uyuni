...
Feature: Check errata
  ...
  Scenario: check all errata exists
    Given I am on the errata page
     ...
     Then I should see a "slessp1-kernel-3280" link
      And I should see a "slessp1-kernel-3284" link
      And I should see a "slessp1-suseRegister-2953" link
      And I should see a "slessp1-aaa_base-sysvinit-2610" link

  Scenario: check slessp1-kernel-3280 errata
    Given I am on the "slessp1-kernel-3280" errata Details page
     Then I should see a "slessp1-kernel-3280 - Security Advisory" text
  ...
  Scenario: check slessp1-kernel-3280 errata packages
    Given I am on the "slessp1-kernel-3280" errata Details page
  ...
  Scenario: check slessp1-kernel-3284 errata
    Given I am on the "slessp1-kernel-3284" errata Details page
     Then I should see a "slessp1-kernel-3284 - Security Advisory" text
      And I should see a "Security update for the Linux kernel" text
  ...
  Scenario: check slessp1-kernel-3284 errata packages
    Given I am on the "slessp1-kernel-3284" errata Details page
     When I follow "Packages"
  ...
  Scenario: check slessp1-suseRegister-2953 errata
    Given I am on the "slessp1-suseRegister-2953" errata Details page
     Then I should see a "slessp1-suseRegister-2953 - Bug Fix Advisory" text
  ...
  Scenario: check slessp1-suseRegister-2953 errata packages
    Given I am on the "slessp1-suseRegister-2953" errata Details page
     When I follow "Packages"
     Then I should see a "SLES11-SP1-Updates x86_64 Channel" text
      ...
      And I should see a "SLES11-SP1-Updates i586 Channel" text
