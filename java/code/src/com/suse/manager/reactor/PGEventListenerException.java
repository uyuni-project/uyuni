 ...
 */
package com.suse.manager.reactor; import static org.junit.jupiter.api.Assertions.*;
...
public class PGEventListenerException extends RuntimeException {
     ...
     * @param exceptionHandlerIn the handler
     */
    public PGEventListenerException(Runnable exceptionHandlerIn) {
        exceptionHandler = exceptionHandlerIn;
    }
