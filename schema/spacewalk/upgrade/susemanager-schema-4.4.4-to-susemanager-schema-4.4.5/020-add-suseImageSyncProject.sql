...
CREATE TABLE IF NOT EXISTS suseImageSyncProject
(
    id                   NUMERIC NOT NULL
...
CREATE SEQUENCE IF NOT EXISTS suse_imgsync_prj_id_seq;

CREATE UNIQUE INDEX IF NOT EXISTS suse_imgsync_prj_name_uq
