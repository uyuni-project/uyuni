...
usage() {
    ...
    print "  --restart-tomcat        Restart tomcat at the end of the deployment"
    print "  --restart-taskomatic    Restart taskomatic at the end of the deployment"
...
deploy_frontend() {
    ...
    local TARGET_DIR="/usr/share/susemanager/www/htdocs/javascript/"
