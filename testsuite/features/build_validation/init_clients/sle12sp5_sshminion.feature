...
Feature: Bootstrap a SLES 12 SP5 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on a SLES 12 SP5 Salt SSH minion
    When I perform a full salt minion cleanup on "sle12sp5_sshminion"
  ...
  Scenario: Bootstrap a SLES 12 SP5 system managed via salt-ssh
    ...
    And I enter the hostname of "sle12sp5_sshminion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-sle12sp5_sshminion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "sle12sp5_sshminion"

@proxy
  Scenario: Check connection from SLES 12 SP5 SSH minion to proxy
    Given I am on the Systems overview page of this "sle12sp5_sshminion"
...
@proxy
  Scenario: Check registration on proxy of SLES 12 SP5 SSH minion
    ...
    Then I should see "sle12sp5_sshminion" hostname
