...
# - srv_sync_all_products.feature which syncs SLES 15 SP5 channles and the client tools.
...
Feature: Migrate Salt to bundled Salt on a SLES 15 SP5 minion
  ...
  Scenario: Create the bootstrap repository for the SLE 15 SP5 minion in the Salt migration context
