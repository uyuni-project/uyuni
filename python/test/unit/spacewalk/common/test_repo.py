...
class TestCommonRepo:
    ...
    def test_has_valid_gpg_signature_call_InRelease(self, verify_file_return, expected):
        ...
        with patch("spacewalk.common.gpgverify.verify_file", verify_file_mock):
            ...
            call_args = verify_file_mock.call_args
            assert call_args.kwargs["signed_file"]
            assert not call_args.kwargs.get("detached_signature_file")
            assert call_args.kwargs["keyring"] == SPACEWALK_GPG_KEYRING
    ...
    def test_has_valid_gpg_signature_call_Release(self, verify_file_return, expected):
        ...
        with patch("spacewalk.common.gpgverify.verify_file", verify_file_mock):
            ...
            call_args = verify_file_mock.call_args
            assert call_args.kwargs["signed_file"]
            assert call_args.kwargs["detached_signature_file"]
            assert call_args.kwargs["keyring"] == SPACEWALK_GPG_KEYRING
