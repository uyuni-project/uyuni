...
@scc_credentials
  Scenario: Create auto installation distribution
    ...
    And I enter "SLE-15-SP3-KVM" as "label"
    ...
    And I should see a "SLE-15-SP3-KVM" link
