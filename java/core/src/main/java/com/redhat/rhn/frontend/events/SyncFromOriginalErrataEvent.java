...
/**
 * SyncFromOriginalErrataEvent - publish event to clone errata from original channel
 * into a cloned channel with package inheritance.
 */
public class SyncFromOriginalErrataEvent implements EventDatabaseMessage {
     ...
     * @param targetChannelLabelIn cloned channel to clone errata into
     * @param syncRequestIn request parameters with sync details
     */
    public SyncFromOriginalErrataEvent(User userIn, String targetChannelLabelIn, SyncRequest syncRequestIn) {
        userId = userIn.getId();
    ...
    public boolean equals(Object oIn) {
        ...
        SyncFromOriginalErrataEvent that = (SyncFromOriginalErrataEvent) oIn;
