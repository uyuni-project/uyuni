...
@peripheral2
@slmicro62_minion
Feature: Smoke tests for slmicro62_minion on peripheral2
  In order to manage slmicro62_minion on peripheral2
  ...
  Scenario: Log in as admin on peripheral2 for SL Micro 6.2 smoke tests
    Given I am authorized for the "Admin" section on "peripheral2"

  Scenario: Check that Software package refresh works on a slmicro62_minion
  ...
  Scenario: Check that Hardware Refresh button works on a slmicro62_minion
    Given I am on the Systems overview page of this "slmicro62_minion" on peripheral2
    ...
    And I wait until there is no Salt job calling the module "hardware.profileupdate" on "slmicro62_minion"

  Scenario: Client slmicro62_minion grains are displayed correctly on the details page
    Given I am on the Systems overview page of this "slmicro62_minion" on peripheral2
    Then the hostname for "slmicro62_minion" should be correct
    And the kernel for "slmicro62_minion" should be correct
  ...
  Scenario: Install a package on the slmicro62_minion
    ...
    And I enter the package for "slmicro62_minion" as the filtered package name
    And I click on the filter button
    And I check the package last version for "slmicro62_minion" in the list
  ...
  Scenario: Remove package from slmicro62_minion
    ...
    And I enter the package for "slmicro62_minion" as the filtered package name
    And I click on the filter button
    And I check the package for "slmicro62_minion" in the list
  ...
  Scenario: Run a remote command on slmicro62_minion
    ...
    And I enter the hostname of "slmicro62_minion" as "target"
  ...
  Scenario: Apply highstate for the Prometheus exporters on the slmicro62_minion
    Given I am on the Systems overview page of this "slmicro62_minion" on peripheral2
  ...
  Scenario: Enable and start Prometheus Node Exporter service on slmicro62_minion
    And I start the "prometheus-node_exporter.service" service on "slmicro62_minion"
    And I enable the "prometheus-node_exporter.service" service on "slmicro62_minion"

  Scenario: Visit Node monitoring endpoint on the slmicro62_minion
    When I wait until "node" exporter service is active on "slmicro62_minion"
    And I visit "Prometheus node exporter" endpoint of this "slmicro62_minion"

  Scenario: Check events history for failures on slmicro62_minion after smoke tests
    Given I am on the Systems overview page of this "slmicro62_minion" on peripheral2
