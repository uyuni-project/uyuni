...
@sle15sp2_client
Feature: Bootstrap a SLES 15 SP2 traditional client
  ...
  Scenario: Register a SLES 15 SP2 traditional client
    ...
    And I run "mgr-actions-control --enable-all" on "sle15sp2_client"
  ...
  Scenario: Check registration values of SLES 15 SP2 traditional
    ...
    When I am on the Systems overview page of this "sle15sp2_client"
...
@proxy
  Scenario: Check connection from SLES 15 SP2 traditional to proxy
    Given I am on the Systems overview page of this "sle15sp2_client"
    When I follow "Details" in the content area
    And I follow "Connection" in the content area
    Then I should see "proxy" short hostname

@proxy
  Scenario: Check registration on proxy of SLES 15 SP2 traditional
    Given I am on the Systems overview page of this "proxy"
    When I follow "Details" in the content area
    And I follow "Proxy" in the content area
    Then I should see "sle15sp2_client" hostname
