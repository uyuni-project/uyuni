...
Feature: Bootstrap a Rocky 9 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on a Rocky 9 Salt SSH minion
    When I perform a full salt minion cleanup on "rocky9_sshminion"
  ...
  Scenario: Bootstrap a Rocky 9 Salt SSH minion
    ...
    And I enter the hostname of "rocky9_sshminion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-rocky9_sshminion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "rocky9_sshminion"

@proxy
  Scenario: Check connection from Rocky 9 Salt SSH minion to proxy
    Given I am on the Systems overview page of this "rocky9_sshminion"
...
@proxy
  Scenario: Check registration on proxy of Rocky 9 Salt SSH minion
    ...
    Then I should see "rocky9_sshminion" hostname
