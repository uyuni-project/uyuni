...
public class ProxyRegistryUtils {
     ...
     * @throws ParseException if the response cannot be parsed
     */
    public static List<String> getRepositories(RegistryUrl registryUrl) throws ParseException {
     ...
     * @throws ParseException if the response cannot be parsed
     */
    public static List<String> getTags(RegistryUrl registryUrl) throws ParseException {
        return executeWithRetry(
