...
@uyuni
  Scenario: Sync openSUSE Leap 15.5 product, including Uyuni Client Tools
    When I call spacewalk-repo-sync to sync the parent channel "opensuse_leap15.5-x86_64"
