...
describe('Regex tests', () => {
  ...
  test('IPv6', () => {
    expect("FE80:0000:0000:0000:0202:B3FF:FE1E:8329".match(utils.ipv6Pattern))
      .toContain("FE80:0000:0000:0000:0202:B3FF:FE1E:8329");
    expect("FE80::0202:B3FF:FE1E:8329".match(utils.ipv6Pattern))
      .toContain("FE80::0202:B3FF:FE1E:8329");
    expect("fe80::0202:b3ff:fe1e:8329".match(utils.ipv6Pattern))
      .toContain("fe80::0202:b3ff:fe1e:8329");
    expect("::1".match(utils.ipv6Pattern))
      .toContain("::1");
    expect("::".match(utils.ipv6Pattern))
      .toContain("::");
    expect("2001:db8::".match(utils.ipv6Pattern))
      .toContain("2001:db8::");
  });

  test('IP', () => {
    expect("192.168.128.5".match(utils.ipPattern)).toContain("192.168.128.5");
    expect("fe80::0202:b3ff:fe1e:8329".match(utils.ipPattern))
      .toContain("fe80::0202:b3ff:fe1e:8329");
  ...
  test('UUID', () => {
    expect("EEBB13ab-bb9f-4665-b587-06e337808ad4".match(utils.uuidPattern))
      .toContain("EEBB13ab-bb9f-4665-b587-06e337808ad4");
    expect("EEBB13abbb9f4665b58706e337808ad4".match(utils.uuidPattern))
      .toContain("EEBB13abbb9f4665b58706e337808ad4");
  });
});
