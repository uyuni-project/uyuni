...
@uyuni
  Scenario: Partially add openSUSE Tumbleweed product, only including the required packages to generate the bootstrap repository
    ...
    And I kill running spacewalk-repo-sync for "opensuse_tumbleweedx86_64" channel
    ...
    And I wait until all synchronized channels for "opensuse_tumbleweed-client-tools-x86_64" have finished
