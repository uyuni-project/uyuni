...
@alma8_minion
Feature: Migrate a Alma 8 Salt minion to SUSE Liberty Linux 8 using Liberate Formula

  Scenario: Prerequisite: Create Liberate System Group for SLL 8
    Given I am authorized for the "Admin" section
    When I follow the left menu "Systems > System Groups"
    And I follow "Create Group"
    And I enter "sll8-migration" as "name"
    And I enter "Systems to be converted to SUSE Liberty Linux 8" as "description"
    And I click on "Create Group"
    Then I should see a "System group sll8-migration created." text
  ...
  Scenario: Prerequisite: Prepare activation key for SLL 8
    ...
    And I enter "sll8_migration_key" as "key"
    And I enter "sll8_migration_key" as "description"
    ...
    Then I wait until I see "Activation key sll8_migration_key has been created." text
    ...
    Then I wait until I see "Activation key sll8_migration_key has been modified." text
    When I follow "Groups" in the content area
    And I follow first "Join"
    And I check the row with the "sll8-migration" link
  ...
  Scenario: Prerequisite: Set environment variables for the bootstrap script on the Alma 8 minion
    When I set the "ACTIVATION_KEYS" environment variable to "1-sll8_migration_key" on this "alma8_minion"
    And I set a reactivation key as environment variable on this "alma8_minion"
    And I navigate to the Systems overview page of this "alma8_minion"
    And I follow "Details" in the content area
    And I follow "Reactivation" in the content area
    Then I should see a "Key:" text

  Scenario: Migrate the Alma 8 minion to SSL 8 with a bootstrap script
    ...
    And I execute the "bootstrap.sh" bootstrap script on this "alma8_minion"
    ...
    And I wait at most 60 seconds until Salt master sees "alma8_minion" as "unaccepted"
    And I accept "alma8_minion" key
    And I wait at most 10 seconds until Salt master sees "alma8_minion" as "accepted"
  ...
  Scenario: Check the migration is successful for this minion
    ...
    Then file "/etc/sysconfig/liberated" should contain "LIBERATED_FROM=" on "alma8_minion"
