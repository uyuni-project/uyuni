...
CHANNEL_TO_SYNC_BY_OS_PRODUCT_VERSION = {
  'SUSE Manager' => {
    ...
    'sl-micro-6.0' => # TODO: Enable when it becomes available whatever it's named exactly suse-manager-tools-for-sl-micro6-updates-6.0-x86_64
      %w[
  ...
  'Uyuni' => {
    ...
    'sl-micro-6.0' => # TODO: Enable when it becomes available, whatever it's named exactly suse-manager-tools-for-micro6-updates-x86_64-6.0
      %w[
        sl-micro-6.0-pool-x86_64
...
TIMEOUT_BY_CHANNEL_NAME = {
  ...
  # TODO: Enable when it becomes available SLE Micro 6.0 Client tools Updates, whatever it's named exactly
