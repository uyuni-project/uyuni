...
public class MinionServer extends Server implements SaltConfigurable {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof MinionServer otherMinionServer) {
            otherMinion = otherMinionServer;
        }
    ...
    public Long[] getSnapshots() {
        return snapshotInfo != null ? snapshotInfo.getSnapshots() : new Long[0];
    }
    ...
    public void setSnapshots(Long[] ids) {
        getOrCreateSnapshotInfo().setSnapshots(ids);
    }
