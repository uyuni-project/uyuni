...
@sle15sp3_minion
Feature: Migrate a SLES 15 SP5 Salt minion to 15 SP6

  Scenario: Log in as admin user
    Given I am authorized for the "Admin" section

  Scenario: Migrate this minion to SLE 15 SP6
    ...
    And I wait until I see "SUSE Linux Enterprise Server 15 SP6 x86_64" text
  ...
  Scenario: Check the migration is successful for this minion
    ...
    Then I wait until I see "SUSE Linux Enterprise Server 15 SP6" text, refreshing the page
    And vendor change should be enabled for product migration on "sle15sp5_minion"

  Scenario: Detect latest Salt changes on the SLES minion
    When I query latest Salt changes on "sle15sp5_minion"
