...
class RepoSync(object):
    ...
    def _populate_erratum(self, notice):
        ...
        existing_packages = existing_errata['packages'].copy() if existing_errata else []
        npkgs = []
...
##############################################################################
    ...
    def errata_needs_update(self, existing_errata, new_errata_version, new_errata_changedate, packages):
        ...
        if packages:
            ...
            if any(
                ...
                log(2, "Patch needs update: Detected packages not previously linked to errata")
                return True
