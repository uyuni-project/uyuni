export default {
  ...
  "admin/access-group": () => import("./access-group/access-group-list.renderer"),
  "admin/create-access-group": () => import("./access-group/access-group-create.renderer"),
  "admin/show-access-group": () => import("./access-group/access-group-show.renderer"),
