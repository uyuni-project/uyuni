...
export function useVirtNotification(
  ...
  const updateActions = (newActions: Object): void => {
    actions = newActions;
    ...
    if (listen) {
      ...
      ws.onmessage = (e) => {
        if (typeof e.data === 'string') {
           ...
           * their IDs.
           */
          const aidMap = Object.keys(actions)
            .reduce((res, key) => Object.assign({}, res, {[actions[key].id]: key}), {});
