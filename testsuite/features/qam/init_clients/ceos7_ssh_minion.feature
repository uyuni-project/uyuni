...
Feature: Bootstrap a SSH-managed CentOS 7 minion and do some basic operations on it
  ...
  Scenario: Bootstrap a SSH-managed CentOS 7 minion
    ...
    And I select "ceos7_ssh_minion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies"
    And I click on "Bootstrap"
    Then I wait until I see "Successfully bootstrapped host!" text
    And I navigate to "rhn/systems/Overview.do" page
    And I wait until I see the name of "ceos7_ssh_minion", refreshing the page
...
@proxy
  ...
  Scenario: Prepare a SSH-managed CentOS 7 minion
    Given I am authorized
    When I enable SUSE Manager tools repositories on "ceos7_ssh_minion"
    When I enable repository "Devel_Galaxy_Manager_4.0_RES-Manager-Tools-7-x86_64" on this "ceos7_ssh_minion"
    And  I enable repository "SLE-Manager-Tools-RES-7-x86_64" on this "ceos7_ssh_minion"
    And  I enable repository "CentOS-Base" on this "ceos7_ssh_minion"
