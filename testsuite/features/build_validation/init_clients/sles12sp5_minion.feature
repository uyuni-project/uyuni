...
Feature: Bootstrap a SLES 12 SP5 Salt minion
  ...
  Scenario: Clean up sumaform leftovers on a SLES 12 SP5 Salt minion
    When I perform a full salt minion cleanup on "sles12sp5_minion"
  ...
  Scenario: Bootstrap a SLES 12 SP5 minion
    ...
    When I enter the hostname of "sles12sp5_minion" as "hostname"
    And I enter "22" as "port"
    And I enter "root" as "user"
    And I enter "linux" as "password"
    And I select "1-sles12sp5_minion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "sles12sp5_minion"

  Scenario: Check the new bootstrapped SLES 12 SP5 minion in System Overview page
    When I follow the left menu "Salt > Keys"
    Then I should see a "accepted" text
    And the Salt master can reach "sles12sp5_minion"

@proxy
  Scenario: Check connection from SLES 12 SP5 minion to proxy
    Given I am on the Systems overview page of this "sles12sp5_minion"
...
@proxy
  Scenario: Check registration on proxy of SLES 12 SP5 minion
    ...
    Then I should see "sles12sp5_minion" hostname
