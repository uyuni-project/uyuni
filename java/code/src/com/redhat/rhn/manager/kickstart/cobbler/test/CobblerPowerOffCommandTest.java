...
/**
 * Tests Cobbler command to power on a system.
 * @version $Rev$
 */
public class CobblerPowerOffCommandTest extends BaseTestCaseWithUser {
    ...
    public void testStore() throws Exception {
        ...
        ValidatorError error = new CobblerPowerOffCommand(user, server).store();
        ...
        assertNull(new CobblerPowerOffCommand(user, server).store());
        ...
        assertEquals("power_system off " + systemRecord.getId(),
