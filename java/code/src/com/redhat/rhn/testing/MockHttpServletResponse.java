...
/**
 * MockHttpServletResponse is a mock implementation of the
...
public class MockHttpServletResponse implements HttpServletResponse {
    ...
    private TestServletOutputStream outputStream = new TestServletOutputStream();
    ...
    public Collection<String> getHeaders(String name) {
        return headers.containsKey(name) ?
            java.util.Collections.singletonList(headers.get(name)) :
    ...
    /**
     * Simple ServletOutputStream implementation for testing
     */
