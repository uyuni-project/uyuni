...
public class ProxyHandler extends BaseHandler {
     ...
     * @apidoc.param #session_key()
     * @apidoc.param #param("int", "hostId", "The ID of the target minion")
     * @apidoc.param #param("string", "parentFqdn", "The FQDN of the server the proxy uses")
     * @apidoc.param #param("int", "proxyPort", "The SSH port the proxy listens on")
     * @apidoc.param #param("int", "maxCache", "The maximum memory cache size")
     * @apidoc.param #param("string", "email", "The email of proxy admin")
     * @apidoc.param #param("string", "rootCA", "CA certificate in PEM format")
     * @apidoc.param #array_single_desc("string", "intermediateCAs", "A list of intermediate CAs in PEM format")
     * @apidoc.param #param("string", "proxyCert", "Proxy certificate in PEM format")
     * @apidoc.param #param("string", "proxyKey", "Proxy private key in PEM format")
     * @apidoc.returntype #return_int_success()
     */
     ...
     * @apidoc.param #param("string", "proxyCert", "Proxy certificate in PEM format")
     * @apidoc.param #param("string", "proxyKey", "Proxy private key in PEM format")
     * @apidoc.param #param("string", "registryBaseURL", "Image registry (e.g. https://registry.opensuse.org/uyuni/)")
     * @apidoc.param #param("string", "registryBaseTag", "Image tag (e.g. latest)")
     * @apidoc.returntype #return_int_success()
     */
    public int bootstrapProxy(User loggedInUser,
        Integer hostId, String parentFqdn,
     ...
     * @apidoc.param #param("string", "proxyCert", "Proxy certificate in PEM format")
     * @apidoc.param #param("string", "proxyKey", "Proxy private key in PEM format")
     * @apidoc.param #param("string", "registryHttpdURL", "Httpd image registry")
     * @apidoc.param #param("string", "registryHttpdTag", "Httpd image tag")
     * @apidoc.param #param("string", "registrySaltbrokerURL", "Salt broker image registry")
     * @apidoc.param #param("string", "registrySaltbrokerTag", "Salt broker image tag")
     * @apidoc.param #param("string", "registrySquidURL", "Squid image registry")
     * @apidoc.param #param("string", "registrySquidTag", "Squid image tag")
     * @apidoc.param #param("string", "registrySshURL", "Ssh image registry")
     * @apidoc.param #param("string", "registrySshTag", "Ssh image tag")
     * @apidoc.param #param("string", "registryTftpdURL", "Tftpd image registry")
     * @apidoc.param #param("string", "registryTftpdTag", "Tftpd image tag")
     * @apidoc.returntype #return_int_success()
     */
    public int bootstrapProxy(User loggedInUser,
        Integer hostId, String parentFqdn,
