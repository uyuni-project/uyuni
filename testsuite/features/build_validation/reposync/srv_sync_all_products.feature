...
@opensuse154arm_minion
  Scenario: Add openSUSE 15.4 for ARM Uyuni Client tools
    When I use spacewalk-common-channel to add all "opensuse_leap15_4 opensuse_leap15_4-backports-updates opensuse_leap15_4-non-oss opensuse_leap15_4-non-oss-updates opensuse_leap15_4-sle-updates opensuse_leap15_4-updates opensuse_leap15_4-uyuni-client-devel" with arch "aarch64"
    And I wait until all synchronized channels for "leap15.4-aarch64" have finished
...
@alma8_minion
  Scenario: Add Alma Linux 8
    # TODOALLHERE When I use spacewalk-common-channel to add channel "almalinux8 almalinux8-appstream almalinux8-extras almalinux8-uyuni-client-devel" with arch "x86_64"
    And I wait until all synchronized channels for "almalinux8" have finished
...
@alma9_minion
  Scenario: Add Alma Linux 9
    # TODOALLHERE When I use spacewalk-common-channel to add channel "almalinux9 almalinux9-appstream almalinux9-extras almalinux9-uyuni-client-devel" with arch "x86_64"
    And I wait until all synchronized channels for "almalinux9" have finished
...
@centos7_minion
  Scenario: Add CentOS 7
    # TODOALLHERE When I use spacewalk-common-channel to add channel "centos7 centos7-extras centos7-uyuni-client-devel" with arch "x86_64"
    And I wait until all synchronized channels for "res7" have finished
...
@oracle9_minion
  Scenario: Add Oracle Linux 9
    # TODOALLHERE When I use spacewalk-common-channel to add channel "oraclelinux9 oraclelinux9-appstream oraclelinux9-uyuni-client-devel" with arch "x86_64"
    And I wait until all synchronized channels for "oraclelinux9" have finished
...
@rocky8_minion
  Scenario: Add Rocky Linux 8
    # TODOALLHERE When I use spacewalk-common-channel to add channel "rockylinux8 rockylinux8-appstream rockylinux8-extras rockylinux8-uyuni-client-devel" with arch "x86_64"
...
@rocky9_minion
  Scenario: Add Rocky Linux 9
    # TODOALLHERE When I use spacewalk-common-channel to add channel "rockylinux9 rockylinux9-appstream rockylinux9-extras rockylinux9-uyuni-client-devel" with arch "x86_64"
    And I wait until all synchronized channels for "rockylinux-9" have finished
...
@debian10_minion
  Scenario: Add Debian 10
    # TODOALLHERE When I use spacewalk-common-channel to add channel "debian-10-pool-amd64-uyuni debian-10-amd64-main-updates-uyuni debian-10-amd64-main-security-uyuni debian-10-amd64-uyuni-client-devel" with arch "amd64-deb"
    And I wait until all synchronized channels for "debian-10" have finished
...
@debian11_minion
  Scenario: Add Debian 11
    # TODOALLHERE When I use spacewalk-common-channel to add channel "debian-11-pool-amd64-uyuni debian-11-amd64-main-updates-uyuni debian-11-amd64-main-security-uyuni debian-11-amd64-uyuni-client-devel" with arch "amd64-deb"
    And I wait until all synchronized channels for "debian-11" have finished
...
@debian12_minion
  Scenario: Add Debian 12
    # TODOALLHERE When I use spacewalk-common-channel to add channel "debian-12-pool-amd64-uyuni debian-12-amd64-main-updates-uyuni debian-12-amd64-main-security-uyuni debian-12-amd64-uyuni-client-devel" with arch "amd64-deb"
    And I wait until all synchronized channels for "debian-12" have finished
