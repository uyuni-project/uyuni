...
<html>
    <body>
        ...
        <p>
            ...
            You have acquired licenses, any media and accompanying documentation
            (collectively the "Software") is protected by the copyright laws and
            treaties of the United States ("U.S.") and other countries and is
            subject to the terms of this Agreement.  If the laws of Your country
            of origin require contracts to be in the local language to be
            ...
            purchase of licenses to the Software.  Any update, mobile
            application, module or adapter or support release to the Software
            that You may download or receive that is not accompanied by a
            license agreement is Software and governed by this Agreement.  If
            the Software is an update or support release, then You must have
            validly licensed the version and quantity of the Software being
            updated or supported in order to install or use the update or
            support release.
        </p><p>
            LICENSED USE
        </p><p>
            ...
            the Software within Your Organization (as defined below). Many of
            the individual components included in the Software are licensed
            pursuant to an open source license identified in the documentation
            or located in the source code or binary code for the component.
            This Agreement does not limit Your rights under such licenses or
            supersede or conflict with the license terms or obligations for use
            of any individual open source component.
        </p><p>
            ...
            SUBSCRIPTION SERVICES.  Licensor sells Subscription Services for
            the Software that entitle You to fee based technical support and
            internal use of Software updates provided during the Subscription
            Service period purchased and subject to the terms of the applicable
            Subscription Service offering. The fee charged for Subscription
            Services for this Software is based on the total number of units of
            the Software You deploy, install or use ("units" of the Software is
            defined by Licensor in the applicable subscription offering).
        </p><p>
            In addition to the Subscription Services for the SUSE Manager
            Server and/or SUSE Manager Proxy, for each unique instance that
            connects to SUSE Manager Server, either directly or via a SUSE
            Manager Proxy, You must purchase the appropriate number of SUSE
            Manager Lifecycle Management subscriptions. You may also need to
            purchase additional subscriptions for some advanced functionality to
            be supported.
        </p><p>
            Furthermore, if you have purchased a subscription that restricts the
            number of managed instances connected to SUSE Manager, then you may
            not register more than that number of managed instances with SUSE
            Manager.
        </p><p>
            ...
            mark of Licensor or its affiliates or licensors ("Mark"). If You
            distribute any open source component of the Software, You must
            remove all Marks except those used to identify Licensor's ownership
            or licensing of the component.
        </p><p>
            PROPRIETARY DATABASE SOFTWARE.  If the Software includes a version
            of Oracle database software ("Database"), for  each unit  of
            Subscription  Services  You  have  purchased  for  the  Software,
            You  are authorized to use one Instance of the Database solely for
            use with the Software for which You have purchased the Subscription.
            In addition to the terms of this Agreement, Your use of the Database
            is subject to the Third Party Addendum included with this Agreement.
        </p><p>
            RESTRICTIONS
        </p><p>
            ...
            support offerings, see http://www.suse.com/support.
        </p><p>
            OWNERSHIP
        </p><p>
            ...
            or return them to Licensor and delete the Software from Your systems.
        </p><p>
            ...
            certify Your compliance with this Agreement, and, upon request of
            Licensor, provide and certify metrics and/or reports based upon such
            records and account for both numbers of copies (by product and
            version) and network architectures as they may reasonably relate to
            Your licensing and deployment of the Software; and  (3)  Allow a
            Licensor representative or an independent auditor ("Auditor") to
            inspect and audit Your, or Your contractor's, computers and records,
            during Your normal business hours, for compliance with the licensing
            terms for Licensor's software products. Upon Licensor's and
            ...
            access to the Software, You will, within 30 days, purchase
            sufficient licenses to cover any shortfall without benefit of any
            otherwise applicable discount and subject to license fees reflecting
            the duration of the shortfall. If a material license shortfall of 5%
            or more is found, You must reimburse Licensor for the costs incurred
            in the audit.
        </p><p>
            ...
            CRC@novell.com to request the transfer of licenses and assignment of
            this Agreement.  This Agreement may not be transferred or assigned
            without the prior written approval of Licensor. Any such attempted
            ...
            country of principal residence is a member state of the European
            Union or the European Free Trade Association, (1) the courts of
            Ireland shall have exclusive jurisdiction over any action of law
            relating to this Agreement; and (2) where the laws of such country
            of principal residence are required to be applied to any such action
            of law the laws of that country shall apply.  The application of the
            ...
            www.Novell.com/info/exports/ . Upon request, Licensor's
            International Trade Services Department can provide information
            regarding applicable export restrictions for Licensor products.
            Licensor assumes no responsibility for Your failure to obtain any
            ...
            The Software contains database software licensed by SUSE or its
            affiliates from Oracle America, Inc. ("Oracle"). For pur-poses of
            this addendum, the term "program" refers to the Oracle database
            software. Oracle requires that You agree to the following terms
            regarding use of the program. You may only use the Oracle program in
            conjunction with the SUSE Man-ager Server with Database Software and
            not as a general purpose database in support of other applications.
            You agree to comply with the following:
        </p><p>
            1) Use of the program is limited to the legal entity that executed
            the SUSE Manager with Database Software License Agreement.
            2) Use of the program is restricted to the scope of the application
            package with which You received it and to Your internal business
            operations. You may permit agents or contractors (including, without
            limitation, outsourcers) to use the applica-tion package on Your
            behalf. You are responsible for Your agent's, contractor's,
            outsourcer's, customer's and supplier's use of the application
            package and compliance with the end user license agreement.
            3) Oracle or its licensor retains all ownership and intellectual
            property rights to the program.
            4) The following are prohibited: (a) use of the program for rental,
            timesharing, subscription service, hosting, or outsourc-ing; (b) the
            removal or modification of any program markings or any notice of
            Oracle's or its licensors' proprietary rights; (c) making the
            programs available in any manner to any third party for use in the
            third party's business operations (un-less such access is expressly
            permitted for the specific program license); (d) reverse engineering
            ...
            but is not limited to review of data structures or similar materials
            produced by programs); and (e) publication of any results of
            benchmark tests run on the programs.
        </p><p>
            To the extent permitted by applicable law, Oracle disclaims
            liability for (a) any damages, whether direct, indirect,
            inci-dental, special, punitive or consequential, and (b) any loss of
            profits, revenue, data or data use, arising from the use of the
            programs. You agree to permit SUSE to audit Your use of the programs
            and report the audit results to Oracle or allow Oracle to perform
            the audit at Your cost. Oracle is a third party beneficiary of this
            addendum and the end user license agreement (with respect only to
            the program). The application of the Uniform Computer Information
            Transactions Act is excluded.
        </p><p>
            (rev July 2012)
        </p>
    </body>
