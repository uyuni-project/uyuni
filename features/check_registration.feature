...
Feature: Check client registration
  ...
  Scenario: check tab links "Provisioning"
    ...
    # If cobbler test was running there is a profile # And I should see a "No profiles found that are compatible with this System.  # Either you haven't created any Kickstart Profiles # or this system does not have a Base Channel." text
