...
PACKAGE_LIST="spacewalk-pylint rhnlib rhn-client-tools rhnsd yum-rhn-plugin spacewalk-koan perl-Satcon spacewalk-proxy-html spacewalk-proxy-docs spacecmd rhn-custom-info spacewalk-config"
