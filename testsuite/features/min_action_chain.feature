...
Feature: Action chain tests for salt minions
  ...
  Scenario: [minion-action-chain] Pre-requisite: downgrade repo to lower version
    ...
    And I run "rhn_check -vvv" on "sle-minion"
    And I follow "Admin"
  ...
  Scenario: [minion-action-chain] Add a package verification to the action chain
    Given I am on the Systems overview page of this "sle-minion"
    When I follow "Software" in the content area
...
#    When I run "rhn_check -vvv" on "sle-minion"
#
