...
Feature: Bootstrap a SLE Micro 5.2 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on a SLE Micro SSH 5.2 SSH minion
    When I perform a full salt minion cleanup on "slemicro52_sshminion"
    And I reboot the "slemicro52_sshminion" host through SSH, waiting until it comes back
  ...
  Scenario: Bootstrap a SLE Micro 5.2 SSH minion
    ...
    And I enter the hostname of "slemicro52_sshminion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-slemicro52_sshminion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "slemicro52_sshminion"

@proxy
  Scenario: Check connection from SLE Micro 5.2 minion to proxy
    Given I am on the Systems overview page of this "slemicro52_sshminion"
...
@proxy
  Scenario: Check registration on proxy of SLE Micro 5.2 SSH minion
    ...
    Then I should see "slemicro52_sshminion" hostname
