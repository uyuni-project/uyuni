...
public final class OpenApiConfig {
    ...
    public static Map<String, Class<?>> getHandlerClasses() {
        ...
        handlers.put("configchannel", ConfigChannelHandler.class);
        ...
        handlers.put("kickstart.profile", ProfileHandler.class);
        ...
        handlers.put("proxy", ProxyHandler.class);
        ...
        handlers.put("systemgroup", ServerGroupHandler.class);
