...
PACKAGE_BY_CLIENT = { 'sle_client' => 'bison',
                      ...
                      'centos8_minion' => 'autoconf',
                      'centos8_ssh_minion' => 'autoconf',
...
BASE_CHANNEL_BY_CLIENT = { 'proxy' => 'SLE-Product-SUSE-Manager-Proxy-4.3-Pool',
                           ...
                           'rh_minion' => 'RHEL7-Pool for x86_64',
                           'deb_minion' => 'ubuntu-18.04-pool',
                           ...
                           'centos8_minion' => 'no-appstream-result-RHEL8-Pool for x86_64',
                           'centos8_ssh_minion' => 'no-appstream-result-RHEL8-Pool for x86_64',
...
PKGARCH_BY_CLIENT = { 'proxy' => 'x86_64',
                      ...
                      'centos8_minion' => 'x86_64',
                      'centos8_ssh_minion' => 'x86_64',
