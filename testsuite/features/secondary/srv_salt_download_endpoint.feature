...
Feature: Endpoint to download packages
  ...
  Scenario: Download package, user without token
    Given I try to download "virgo-dummy-2.0-1.1.noarch.rpm" from channel "fake-rpm-sles15sp4-channel"
  ...
  Scenario: Download package, user with a valid token for the org
    ...
    When I try to download "virgo-dummy-2.0-1.1.noarch.rpm" from channel "fake-rpm-sles15sp4-channel"
