...
Feature: Listing, adding and removing channels using the spacewalk-channel command
  ...
  Scenario: List available channels, verify child channels
    ...
    Then I should get "sle15-sp3-installer-updates-x86_64"
  ...
  Scenario: Add a valid child channel
    When I use spacewalk-channel to add "sle15-sp3-installer-updates-x86_64"
    And I use spacewalk-channel to list channels
    Then I should get "sle15-sp3-installer-updates-x86_64"

  Scenario: Remove a valid child channel
    When I use spacewalk-channel to remove "sle15-sp3-installer-updates-x86_64"
    And I use spacewalk-channel to list channels
    Then I shouldn't get "sle15-sp3-installer-updates-x86_64"
