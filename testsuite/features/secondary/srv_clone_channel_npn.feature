...
Feature: Clone a channel
  ...
  Scenario: Clone a channel with patches
    ...
    And I click on "Clone Channel"
    Then I should see a "Clone 2 of Fake-RPM-SLES15SP4-Channel" text

  Scenario: Check that this channel has patches
    When I follow the left menu "Software > Manage > Channels"
    And I follow "Clone 2 of Fake-RPM-SLES15SP4-Channel"
    And I follow "Patches" in the content area
    And I follow "List/Remove Patches"
  ...
  Scenario: Clone a channel with selected patches
    ...
    And I click on "Clone Channel"
    And I should see a "Clone 3 of Fake-RPM-SLES15SP4-Channel" text
    And I should see a "Channel Clone 3 of Fake-RPM-SLES15SP4-Channel cloned from channel Fake-RPM-SLES15SP4-Channel." text
    And I should see a "You may now wish to clone the patches associated with Fake-RPM-SLES15SP4-Channel." text
  ...
  Scenario: Compare channel packages
    ...
    And I select "Clone 3 of Fake-RPM-SLES15SP4-Channel" from "selected_channel"
  ...
  Scenario: Cleanup: remove cloned channels
    ...
    When I follow "Clone 2 of Fake-RPM-SLES15SP4-Channel"
    And I follow "Delete software channel"
    And I check "unsubscribeSystems"
    And I click on "Delete Channel"
    Then I should see a "Clone 2 of Fake-RPM-SLES15SP4-Channel" text
    And I should see a "has been deleted." text
    Given I follow the left menu "Software > Manage > Channels"
    When I follow "Clone 3 of Fake-RPM-SLES15SP4-Channel"
    And I follow "Delete software channel"
    And I check "unsubscribeSystems"
    And I click on "Delete Channel"
    Then I should see a "Clone 3 of Fake-RPM-SLES15SP4-Channel" text
    And I should see a "has been deleted." text
