...
export const mapping = {
    bridge: {
      description: t('Use an existing and configured bridge device. ' +
        'No iptables rule, IP address or DHCP/DNS service are added'),
      bridge_name: true,
      interfaces: true,
    ...
    macvtap: {
      description: t('Network based on macvtap driver to use a pool of physical interfaces. ' +
