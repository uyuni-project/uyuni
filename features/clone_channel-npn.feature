Feature: Clone a Channel
  ...
  Scenario: Check, that this channel has erratas
    Given I am on the manage software channels page
     ...
     When I follow "Errata" in class "content-nav"
      And I follow "List/Remove Errata"
     Then I should see a "CLssp1-kernel-3280" link
      And I should see a "CLssp1-suseRegister-2953" link
      And I should see a "CLssp1-aaa_base-sysvinit-2610" link
  ...
  Scenario: Clone a Channel with selected errata
    ...
    When I follow "clone channel"
     ...
     And I choose "Merge w/CLssp1-aaa_base-sysvinit-2610" for "slessp1-aaa_base-sysvinit-2610"
     And I choose "Clone as CLssp1-suseRegister-2953-1" for "slessp1-suseRegister-2953"
     And I choose "Do Nothing" for "slessp1-kernel-3280"
     And I click on "Clone Errata"
     And I click on "Update Errata"
     And I follow "List/Remove Errata"
    Then I should see a "CLssp1-suseRegister-2953-1" link
     And I should see a "CLssp1-aaa_base-sysvinit-2610" link
  ...
  Scenario: check new errata exists
    Given I am on the errata page
     ...
     Then I should see a "CLssp1-kernel-3280" link
      And I should see a "CLssp1-suseRegister-2953" link
      And I should see a "CLssp1-suseRegister-2953-1" link
      And I should see a "CLssp1-aaa_base-sysvinit-2610" link

  Scenario: check CLssp1-suseRegister-2953 errata
    Given I am on the "CLssp1-suseRegister-2953" errata Details page
     Then I should see a "CLssp1-suseRegister-2953 - Bug Fix Advisory" text
  ...
  Scenario: check CLssp1-suseRegister-2953-1 errata
    Given I am on the "CLssp1-suseRegister-2953-1" errata Details page
     Then I should see a "CLssp1-suseRegister-2953-1 - Bug Fix Advisory" text
      And I should see a "maint-coord@suse.de" text
      And I should see a "bug number 546142" link
      And I should see a "restart_suggested" text
