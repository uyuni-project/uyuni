...
Feature: Prepare the branch server for PXE booting
  ...
  Scenario: Parametrize DHCP on the Retail branch server
    ...
    And I enter "sles15sp6terminal" in first reserved hostname field
    And I enter the local IP address of "sles15sp6_terminal" in first reserved IP field
    And I enter the MAC address of "sles15sp6_terminal" in first reserved MAC field
    And I press "Add Item" in host reservations section
    And I enter "sles15sp7terminal" in second reserved hostname field
    And I enter the local IP address of "sles15sp7_terminal" in second reserved IP field
    And I enter the MAC address of "sles15sp7_terminal" in second reserved MAC field
    And I click on "Save Formula"
    Then I should see a "Formula saved" text
  ...
  Scenario: Parametrize DNS on the Retail branch server
    ...
    And I enter "sles15sp6terminal" in second A name field of example.org zone
    And I enter the local IP address of "sles15sp6_terminal" in second A address field of example.org zone
    And I press "Add Item" in A section of example.org zone
    And I enter "sles15sp7terminal" in third A name field of example.org zone
    And I enter the local IP address of "sles15sp7_terminal" in third A address field of example.org zone
