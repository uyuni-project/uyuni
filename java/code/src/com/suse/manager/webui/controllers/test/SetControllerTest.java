...
public class SetControllerTest extends BaseControllerTestCase {
    ...
    @Test
    public void throwsExceptionWhenUpdatingNonExistingSet() throws UnsupportedEncodingException {
        Request request = SparkTestUtils.createMockRequestWithBodyAndParams(
            "/manager/api/sets/:label",
            Map.of(),
        ...
        assertThrows(NotFoundException.class, () -> SetController.updateSet(request, response, user));
    }
