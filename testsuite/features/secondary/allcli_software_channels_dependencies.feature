...
Feature: Channel subscription with recommended or required dependencies
  ...
  Scenario: Play with recommended and required child channels selection in SSM
    ...
    And I should see a table line with "Fake-RPM-SLES15SP4-Channel", "1"
    When I select "System Default Base Channel" from drop-down in table line with "Fake-RPM-SLES15SP4-Channel"
    And I click on "Next"
