...
public class SnapshotRefreshAction extends Action {
    ...
    public void handleUpdateServerAction(ServerAction serverAction, JsonElement jsonResult, UpdateAuxArgs auxArgs) {
        ...
        serverAction.getServer().asMinionServer().ifPresent(minionServer -> {
            ...
            Optional<BtrfsSnapshotUtils.ParseResult> snapshotInfo =
            ...
            if (snapshotInfo.isEmpty()) {
                ...
                serverAction.setResultMsg("Unable to refresh Btrfs snapshot information");
                return;
            }
            ...
            TransactionalActionManager.reconcileSnapshotRefreshAction(
                    minionServer.getId(),
                    getId(),
                    BtrfsSnapshotUtils.hasPendingTransactionalReboot(snapshotInfo.get()));
