 ...
 */
package com.redhat.rhn.frontend.action.configuration.ssm; import static org.junit.jupiter.api.Assertions.*;
...
public class ConfigListAction extends BaseSetListAction {
    ...
    protected DataResult getDataResult(RequestContext rctxIn, PageControl pcIn) {
        ...
        return ConfigurationManager.getInstance().listFileNamesForSsm(user, pcIn);
    }
