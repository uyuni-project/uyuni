...
@sle15sp6_client
  Scenario: The SLES 15 SP6 traditional client is healthy
    Then "sle15sp6_client" should have a FQDN
    And reverse resolution should work for "sle15sp6_client"
    And "sle15sp6_client" should communicate with the server using public interface
    And the clock from "sle15sp6_client" should be exact
...
@sle15sp7_client
  Scenario: The SLES 15 SP7 traditional client is healthy
    Then "sle15sp7_client" should have a FQDN
    And reverse resolution should work for "sle15sp7_client"
    And "sle15sp7_client" should communicate with the server using public interface
    And the clock from "sle15sp7_client" should be exact
