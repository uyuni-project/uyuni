...
if [ -n "$1" ]; then
    ...
    echo "█████████████████████████████████████████████████████████████████████████████████"
    zypper addrepo http://download.opensuse.org/distribution/leap/15.4/repo/oss/ main-oss
    zypper addrepo http://download.opensuse.org/update/leap/15.4/sle/ sle-updates
